...
if ($user['invitedby'] > 0) {
    ...
    $HTMLOUT .= '<tr><td class="heading">' . $lang['userdetails_invited_by'] . '</td><td>' . format_username($user_get_invitor) . '</td></tr>';
} else {
    $HTMLOUT .= '<tr><td class="heading">' . $lang['userdetails_invited_by'] . '</td><td><b>' . $lang['userdetails_iopen_s'] . '</b></td></tr>';
}
...
$HTMLOUT .= '<tr><td class="heading">' . $lang['userdetails_invitees'] . '</td><td>' . (mysqli_num_rows($rez_invited) > 0 ? $the_flip_box_5 . '<div id="box_5" style="display:none">
