...
$HTMLOUT.= (($CURUSER['class'] >= UC_STAFF || $user['show_email'] === 'yes') ? '
		<tr>
			...
			<td align="left"><a class="altlink" href="mailto:' . htmlsafechars($user['email']) . '"  title="' . $lang['userdetails_email_click'] . '" target="_blank"><img src="pic/email.gif" alt="email" width="25" />' . $lang['userdetails_send_email'] . '</a></td>
		</tr>' : '') . ($user['google_talk'] !== '' ? '
		<tr>
