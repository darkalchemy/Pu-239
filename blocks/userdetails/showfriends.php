...
if (count($users_friends) > 0) {
    ...
    if ($users_friends) {
        ...
        $user_friends .= '</table>';
        $HTMLOUT .= "<tr><td class='rowhead'>{$lang['userdetails_friends']}</td><td width='99%'><a href=\"javascript: klappe_news('a6')\"><img border='0' src='{$site_config['pic_base_url']}plus.png' id='pica6" . (int)$a['uid'] . "' alt='{$lang['userdetails_hide_show']}' title='{$lang['userdetails_hide_show']}' /></a><div id='ka6' style='display: none;'><br>$user_friends</div></td></tr>";
    } else {
