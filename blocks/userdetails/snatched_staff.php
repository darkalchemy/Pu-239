        ...
        if (!XBT_TRACKER) {
            ...
            <tr>
                ...
                <td>
                    ...
                    ' . get_date($arr['complete_date'], 0, 1) . ' ' .
                    ($arr['complete_date'] == '0' ? '' .
                        ($arr['owner'] == $id ? '' : '[ ' . mksize($arr['size'] - $arr['downloaded']) . "{$lang['userdetails_s_still']}]") : '') : '') . '<br>' . $lang['userdetails_s_finished'] . get_date($arr['complete_date'], 0, 1) . '' . ($arr['complete_date'] != '0' ? "<br>
