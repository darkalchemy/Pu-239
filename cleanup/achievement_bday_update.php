    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        while ($arr = mysqli_fetch_assoc($res)) {
            ...
            if ($bday === 0 && $added < $maxdt) {
                $msg = 'Congratulations, you have just earned the [b]First Birthday[/b] achievement. :) [img]' . $site_config['pic_baseurl'] . 'achievements/birthday1.png[/img]';
                ...
                $msg = 'Congratulations, you have just earned the [b]Second Birthday[/b] achievement. :) [img]' . $site_config['pic_baseurl'] . 'achievements/birthday2.png[/img]';
                ...
                $msg = 'Congratulations, you have just earned the [b]Third Birthday[/b] achievement. :) [img]' . $site_config['pic_baseurl'] . 'achievements/birthday3.png[/img]';
                ...
                $msg = 'Congratulations, you have just earned the [b]Fourth Birthday[/b] achievement. :) [img]' . $site_config['pic_baseurl'] . 'achievements/birthday4.png[/img]';
                ...
                $msg = 'Congratulations, you have just earned the [b]Fifth Birthday[/b] achievement. :) [img]' . $site_config['pic_baseurl'] . 'achievements/birthday5.png[/img]';
                ...
                $msg = 'Congratulations, you have just earned the [b]Sixth Birthday[/b] achievement. :) [img]' . $site_config['pic_baseurl'] . 'achievements/birthday6.png[/img]';
