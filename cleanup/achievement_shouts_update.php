    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        while ($arr = mysqli_fetch_assoc($res)) {
            ...
            if ($shouts >= 1 && $lvl === 0) {
                ...
                $msg = 'Congratulations, you have just earned the [b]AJAX Chat Spammer Level 2[/b] achievement. :) [img]' . $site_config['pic_baseurl'] . 'achievements/spam2.png[/img]';
                ...
                $msg = 'Congratulations, you have just earned the [b]AJAX Chat Spammer Level 3[/b] achievement. :) [img]' . $site_config['pic_baseurl'] . 'achievements/spam3.png[/img]';
                ...
                $msg = 'Congratulations, you have just earned the [b]AJAX Chat Spammer Level 4[/b] achievement. :) [img]' . $site_config['pic_baseurl'] . 'achievements/spam4.png[/img]';
                ...
                $msg = 'Congratulations, you have just earned the [b]AJAX Chat Spammer Level 5[/b] achievement. :) [img]' . $site_config['pic_baseurl'] . 'achievements/spam5.png[/img]';
        ...
        if ($data['clean_log'] && $queries > 0) {
            write_log("Achievements Cleanup: Shouter Completed using $queries queries. Shouter Achievements awarded to - " . $count . ' Member(s).' . $text);
        }
