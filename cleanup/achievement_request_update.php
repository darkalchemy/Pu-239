    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        while ($arr = mysqli_fetch_assoc($res)) {
            ...
            if ($reqfilled >= 1 && $lvl == 0) {
                ...
                $msg = 'Congratulations, you have just earned the [b]Request Filler LVL2[/b] achievement. :) [img]' . $site_config['pic_baseurl'] . 'achievements/reqfiller2.png[/img]';
                ...
                $msg = 'Congratulations, you have just earned the [b]Request Filler LVL3[/b] achievement. :) [img]' . $site_config['pic_baseurl'] . 'achievements/reqfiller3.png[/img]';
                ...
                $msg = 'Congratulations, you have just earned the [b]Request Filler LVL4[/b] achievement. :) [img]' . $site_config['pic_baseurl'] . 'achievements/reqfiller4.png[/img]';
                ...
                $msg = 'Congratulations, you have just earned the [b]Request Filler LVL5[/b] achievement. :) [img]' . $site_config['pic_baseurl'] . 'achievements/reqfiller5.png[/img]';
        ...
        if ($data['clean_log'] && $queries > 0) {
            write_log("Achievements Cleanup: Request Filler Completed using $queries queries. Request Filler Achievements awarded to - " . $count . ' Member(s).' . $text);
        }
