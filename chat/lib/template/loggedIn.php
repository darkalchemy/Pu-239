...
<div id="content">
            ...
            <div id="settingsList">
                ...
                <dl>
                    ...
                    <dd><input type="checkbox" id="bbCodeSetting"
                               onclick="ajaxChat.setSetting('bbCode', this.checked);"/></dd>
                </dl>
                <dl>
                    <dt><label for="bbCodeImagesSetting">[LANG]settingsBBCodeImages[/LANG]</label></dt>
                    <dd><input type="checkbox" id="bbCodeImagesSetting"
                               onclick="ajaxChat.setSetting('bbCodeImages', this.checked);"/></dd>
                </dl>
                <dl>
                    <dt><label for="bbCodeColorsSetting">[LANG]settingsBBCodeColors[/LANG]</label></dt>
                    <dd><input type="checkbox" id="bbCodeColorsSetting"
                               onclick="ajaxChat.setSetting('bbCodeColors', this.checked);"/></dd>
                </dl>
                <dl>
                    <dt><label for="hyperLinksSetting">[LANG]settingsHyperLinks[/LANG]</label></dt>
                    <dd><input type="checkbox" id="hyperLinksSetting"
                               onclick="ajaxChat.setSetting('hyperLinks', this.checked);"/></dd>
                </dl>
                <dl>
                    <dt><label for="lineBreaksSetting">[LANG]settingsLineBreaks[/LANG]</label></dt>
                    <dd><input type="checkbox" id="lineBreaksSetting"
                               onclick="ajaxChat.setSetting('lineBreaks', this.checked);"/></dd>
                </dl>
                <dl>
                    <dt><label for="emoticonsSetting">[LANG]settingsEmoticons[/LANG]</label></dt>
                    <dd><input type="checkbox" id="emoticonsSetting"
                               onclick="ajaxChat.setSetting('emoticons', this.checked);"/></dd>
                </dl>
                <dl>
                    <dt><label for="autoFocusSetting">[LANG]settingsAutoFocus[/LANG]</label></dt>
                    <dd><input type="checkbox" id="autoFocusSetting"
                               onclick="ajaxChat.setSetting('autoFocus', this.checked);"/></dd>
                </dl>
                <dl>
                    <dt><label for="maxMessagesSetting">[LANG]settingsMaxMessages[/LANG]</label></dt>
                    <dd><input type="text" class="text" id="maxMessagesSetting"
                               onchange="ajaxChat.setSetting('maxMessages', parseInt(this.value));"/></dd>
                </dl>
                <dl>
                    <dt><label for="wordWrapSetting">[LANG]settingsWordWrap[/LANG]</label></dt>
                    <dd><input type="checkbox" id="wordWrapSetting"
                               onclick="ajaxChat.setSetting('wordWrap', this.checked);"/></dd>
                </dl>
                <dl>
                    <dt><label for="maxWordLengthSetting">[LANG]settingsMaxWordLength[/LANG]</label></dt>
                    <dd><input type="text" class="text" id="maxWordLengthSetting"
                               onchange="ajaxChat.setSetting('maxWordLength', parseInt(this.value));"/></dd>
                </dl>
                <dl>
                    <dt><label for="dateFormatSetting">[LANG]settingsDateFormat[/LANG]</label></dt>
                    <dd><input type="text" class="text" id="dateFormatSetting"
                               onchange="ajaxChat.setSetting('dateFormat', this.value);"/></dd>
                </dl>
                <dl>
                    <dt><label for="persistFontColorSetting">[LANG]settingsPersistFontColor[/LANG]</label></dt>
                    <dd><input type="checkbox" id="persistFontColorSetting"
                               onclick="ajaxChat.setPersistFontColor(this.checked);"/></dd>
                </dl>
                <dl>
                    <dt><label for="audioBackendSetting">[LANG]settingsAudioSupport[/LANG]</label></dt>
                    <dd>
                        <select id="audioBackendSetting"
                                onchange="ajaxChat.setAudioBackend(this.options[this.selectedIndex].value);">
                ...
                <dl>
                    ...
                    <dd>
                        <select class="left" id="audioVolumeSetting"
                                onchange="ajaxChat.setAudioVolume(this.options[this.selectedIndex].value);">
                ...
                <dl>
                    ...
                    <dd><select id="soundReceiveSetting"
                                onchange="ajaxChat.setSetting('soundReceive', this.options[this.selectedIndex].value);">
                        <option value="">-</option>
                    </select><input type="image" src="img/pixel.gif" class="button playback"
                                    alt="[LANG]playSelectedSound[/LANG]" title="[LANG]playSelectedSound[/LANG]"
                                    onclick="ajaxChat.playSound(this.previousSibling.options[this.previousSibling.selectedIndex].value);"/>
                    </dd>
                </dl>
                <dl>
                    <dt><label for="soundSendSetting">[LANG]settingsSoundSend[/LANG]</label></dt>
                    <dd><select id="soundSendSetting"
                                onchange="ajaxChat.setSetting('soundSend', this.options[this.selectedIndex].value);">
                        <option value="">-</option>
                    </select><input type="image" src="img/pixel.gif" class="button playback"
                                    alt="[LANG]playSelectedSound[/LANG]" title="[LANG]playSelectedSound[/LANG]"
                                    onclick="ajaxChat.playSound(this.previousSibling.options[this.previousSibling.selectedIndex].value);"/>
                ...
                <dl>
                    ...
                    <dd><select id="soundEnterSetting"
                                onchange="ajaxChat.setSetting('soundEnter', this.options[this.selectedIndex].value);">
                        <option value="">-</option>
                    </select><input type="image" src="img/pixel.gif" class="button playback"
                                    alt="[LANG]playSelectedSound[/LANG]" title="[LANG]playSelectedSound[/LANG]"
                                    onclick="ajaxChat.playSound(this.previousSibling.options[this.previousSibling.selectedIndex].value);"/>
                ...
                <dl>
                    ...
                    <dd><select id="soundLeaveSetting"
                                onchange="ajaxChat.setSetting('soundLeave', this.options[this.selectedIndex].value);">
                        <option value="">-</option>
                    </select><input type="image" src="img/pixel.gif" class="button playback"
                                    alt="[LANG]playSelectedSound[/LANG]" title="[LANG]playSelectedSound[/LANG]"
                                    onclick="ajaxChat.playSound(this.previousSibling.options[this.previousSibling.selectedIndex].value);"/>
                ...
                <dl>
                    ...
                    <dd><select id="soundChatBotSetting"
                                onchange="ajaxChat.setSetting('soundChatBot', this.options[this.selectedIndex].value);">
                        <option value="">-</option>
                    </select><input type="image" src="img/pixel.gif" class="button playback"
                                    alt="[LANG]playSelectedSound[/LANG]" title="[LANG]playSelectedSound[/LANG]"
                                    onclick="ajaxChat.playSound(this.previousSibling.options[this.previousSibling.selectedIndex].value);"/>
                ...
                <dl>
                    ...
                    <dd><select id="soundErrorSetting"
                                onchange="ajaxChat.setSetting('soundError', this.options[this.selectedIndex].value);">
                        <option value="">-</option>
                    </select><input type="image" src="img/pixel.gif" class="button playback"
                                    alt="[LANG]playSelectedSound[/LANG]" title="[LANG]playSelectedSound[/LANG]"
                                    onclick="ajaxChat.playSound(this.previousSibling.options[this.previousSibling.selectedIndex].value);"/>
                ...
                <dl>
                    ...
                    <dd><select id="soundPrivateSetting"
                                onchange="ajaxChat.setSetting('soundPrivate', this.options[this.selectedIndex].value);">
                        <option value="">-</option>
                    </select><input type="image" src="img/pixel.gif" class="button playback"
                                    alt="[LANG]playSelectedSound[/LANG]" title="[LANG]playSelectedSound[/LANG]"
                                    onclick="ajaxChat.playSound(this.previousSibling.options[this.previousSibling.selectedIndex].value);"/>
                ...
                <dl>
                    ...
                    <dd><input type="checkbox" id="blinkSetting" onclick="ajaxChat.setSetting('blink', this.checked);"/>
                    </dd>
                </dl>
                <dl>
                    <dt><label for="blinkIntervalSetting">[LANG]settingsBlinkInterval[/LANG]</label></dt>
                    <dd><input type="text" class="text" id="blinkIntervalSetting"
                               onchange="ajaxChat.setSetting('blinkInterval', parseInt(this.value));"/></dd>
                </dl>
                <dl>
                    <dt><label for="blinkIntervalNumberSetting">[LANG]settingsBlinkIntervalNumber[/LANG]</label></dt>
                    <dd><input type="text" class="text" id="blinkIntervalNumberSetting"
                               onchange="ajaxChat.setSetting('blinkIntervalNumber', parseInt(this.value));"/></dd>
                </dl>
            </div>
        </div>
        <div id="chatList"></div>
    ...
    <div id="inputFieldContainer">
        <textarea id="inputField" rows="1" cols="50" title="[LANG]inputLineBreak[/LANG]"
                  onkeydown="ajaxChat.handleInputFieldKeyDown(event);"
                  onkeyup="ajaxChat.handleInputFieldKeyUp(event);"></textarea>
    </div>
    ...
    <div id="bbCodeContainer">
        <input id="bbCodeBold" type="button" value="[LANG]bbCodeLabelBold[/LANG]" title="[LANG]bbCodeTitleBold[/LANG]"
               onclick="ajaxChat.insertBBCode('b');" style="font-weight:bold;"/>
        <input id="bbCodeItalic" type="button" value="[LANG]bbCodeLabelItalic[/LANG]"
               title="[LANG]bbCodeTitleItalic[/LANG]" onclick="ajaxChat.insertBBCode('i');" style="font-style:italic;"/>
        <input id="bbCodeUnderline" type="button" value="[LANG]bbCodeLabelUnderline[/LANG]"
               title="[LANG]bbCodeTitleUnderline[/LANG]" onclick="ajaxChat.insertBBCode('u');"
               style="text-decoration:underline;"/>
        <input id="bbCodeQuote" type="button" value="[LANG]bbCodeLabelQuote[/LANG]"
               title="[LANG]bbCodeTitleQuote[/LANG]" onclick="ajaxChat.insertBBCode('quote');"/>
        <input id="bbCodeCode" type="button" value="[LANG]bbCodeLabelCode[/LANG]" title="[LANG]bbCodeTitleCode[/LANG]"
               onclick="ajaxChat.insertBBCode('code');"/>
        <input id="bbCodeURL" type="button" value="[LANG]bbCodeLabelURL[/LANG]" title="[LANG]bbCodeTitleURL[/LANG]"
               onclick="ajaxChat.insertBBCode('url');"/>
        <input id="bbCodeIMG" type="button" value="[LANG]bbCodeLabelImg[/LANG]" title="[LANG]bbCodeTitleImg[/LANG]"
               onclick="ajaxChat.insertBBCode('img');"/>
        <input id="bbCodeColor" type="button" value="[LANG]bbCodeLabelColor[/LANG]"
               title="[LANG]bbCodeTitleColor[/LANG]"/>
        <input id="bbCodeEmoticon" type="button" value="[LANG]bbCodeLabelEmoticon[/LANG]"
               title="[LANG]bbCodeTitleEmoticon[/LANG]"/>
        <input id="bbCodeSmilies" type="button" value="Smilies" onclick="PopMoreSmiles();" />
    </div>
    <div id="colorCodesContainer" style="display:none;" dir="ltr"></div>
    <div id="optionsContainer">
        <input type="image" src="img/pixel.gif" class="button" id="helpButton" alt="[LANG]toggleHelp[/LANG]"
               title="[LANG]toggleHelp[/LANG]"
               onclick="ajaxChat.view.toggleContainer('helpContainer', ['onlineListContainer','settingsContainer']);"/>
        <input type="image" src="img/pixel.gif" class="button" id="settingsButton" alt="[LANG]toggleSettings[/LANG]"
               title="[LANG]toggleSettings[/LANG]"
               onclick="ajaxChat.view.toggleContainer('settingsContainer', ['onlineListContainer','helpContainer']);"/>
        <input type="image" src="img/pixel.gif" class="button" id="onlineListButton" alt="[LANG]toggleOnlineList[/LANG]"
               title="[LANG]toggleOnlineList[/LANG]"
               onclick="ajaxChat.view.toggleContainer('onlineListContainer', ['settingsContainer','helpContainer']);"/>
        <input type="image" src="img/pixel.gif" class="button" id="audioButton" alt="[LANG]toggleAudio[/LANG]"
               title="[LANG]toggleAudio[/LANG]" onclick="ajaxChat.toggleSetting('audio', 'audioButton');"/>
        <input type="image" src="img/pixel.gif" class="button" id="autoScrollButton" alt="[LANG]toggleAutoScroll[/LANG]"
               title="[LANG]toggleAutoScroll[/LANG]"
               onclick="ajaxChat.toggleSetting('autoScroll', 'autoScrollButton');"/>
    </div>
...
<![endif]-->
<script src="js/7d8059ce79e5eb4ed4f8f4f983cb62fe.min.js" charset="UTF-8"></script>
<script>
