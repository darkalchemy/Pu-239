...
function get_file_name($file)
{
    ...
    switch ($file) {
        ...
        case 'sceditor_css':
            return "{$site_config['paths']['baseurl']}/css/1/sceditor_7f5ad67a.css";
        case 'main_css':
            return "{$site_config['paths']['baseurl']}/css/1/main_e884b9c7.css";
        case 'last_css':
        ...
        case 'sceditor_js':
            return "{$site_config['paths']['baseurl']}/js/1/sceditor_7ff0e06e.js";
        case 'cheaters_js':
