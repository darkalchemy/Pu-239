...
function get_file_name($file)
{
    ...
    switch ($file) {
        case 'chat_css_trans':
            return "{$site_config['paths']['baseurl']}/css/1/chat_trans_977de212.css";
        case 'chat_css_uranium':
            return "{$site_config['paths']['baseurl']}/css/1/chat_uranium_0cceb0be.css";
        case 'index_css':
        ...
        case 'sceditor_css':
            return "{$site_config['paths']['baseurl']}/css/1/sceditor_2d40cad4.css";
        case 'main_css':
            return "{$site_config['paths']['baseurl']}/css/1/main_76142f1d.css";
        case 'last_css':
        ...
        case 'sceditor_js':
            return "{$site_config['paths']['baseurl']}/js/1/sceditor_44c74417.js";
        case 'cheaters_js':
