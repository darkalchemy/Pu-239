...
function get_file_name($file)
{
    ...
    switch ($file) {
        case 'chat_css_trans':
            return "{$site_config['paths']['baseurl']}/css/1/chat_trans_03fdbc01.css";
        case 'chat_css_uranium':
            return "{$site_config['paths']['baseurl']}/css/1/chat_uranium_4bdbeec9.css";
        case 'css':
        ...
        case 'sceditor_css':
            return "{$site_config['paths']['baseurl']}/css/1/sceditor_c15d0213.css";
        case 'main_css':
            return "{$site_config['paths']['baseurl']}/css/1/main_fe17f00e.css";
        case 'main_js':
        ...
        case 'sceditor_js':
            return "{$site_config['paths']['baseurl']}/js/1/sceditor_f04ad8bf.js";
        case 'cheaters_js':
