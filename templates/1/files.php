...
function get_file_name($file)
{
    ...
    switch ($file) {
        ...
        case 'sceditor_css':
            return "{$site_config['paths']['baseurl']}/css/1/sceditor_d456629a.css";
        case 'main_css':
            return "{$site_config['paths']['baseurl']}/css/1/main_79eca89b.css";
        case 'last_css':
        ...
        case 'sceditor_js':
            return "{$site_config['paths']['baseurl']}/js/1/sceditor_65adaaa6.js";
        case 'cheaters_js':
