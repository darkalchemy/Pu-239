...
function get_file_name($file)
{
    ...
    switch ($file) {
        ...
        case 'sceditor_css':
            return "{$site_config['baseurl']}/css/1/sceditor_c975365f.css";
        case 'main_css':
            return "{$site_config['baseurl']}/css/1/main_4f693764.css";
        case 'main_js':
        ...
        case 'sceditor_js':
            return "{$site_config['baseurl']}/js/1/sceditor_03301a77.js";
        case 'cheaters_js':
