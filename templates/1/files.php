...
function get_file_name($file)
{
    ...
    switch ($file) {
        ...
        case 'sceditor_css':
            return "{$site_config['paths']['baseurl']}/css/1/sceditor_7c5273f6.css";
        case 'main_css':
            return "{$site_config['paths']['baseurl']}/css/1/main_59840c76.css";
        case 'last_css':
        ...
        case 'sceditor_js':
            return "{$site_config['paths']['baseurl']}/js/1/sceditor_b64d141a.js";
        case 'cheaters_js':
