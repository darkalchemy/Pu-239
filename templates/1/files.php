...
function get_file_name($file)
{
    ...
    switch ($file) {
        ...
        case 'sceditor_css':
            return "{$site_config['paths']['baseurl']}/css/1/sceditor_3a27279a.css";
        case 'main_css':
            return "{$site_config['paths']['baseurl']}/css/1/main_f3fda262.css";
        case 'main_js':
        ...
        case 'browse_js':
            return "{$site_config['paths']['baseurl']}/js/1/browse_c6aa24a1.js";
        case 'scroller_js':
        ...
        case 'sceditor_js':
            return "{$site_config['paths']['baseurl']}/js/1/sceditor_fc2f1814.js";
        case 'cheaters_js':
