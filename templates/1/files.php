...
function get_file_name($file)
{
    ...
    switch ($file) {
        ...
        case 'sceditor_css':
            return "{$site_config['paths']['baseurl']}/css/1/sceditor_a775ca8a.css";
        case 'main_css':
            return "{$site_config['paths']['baseurl']}/css/1/main_214d9e87.css";
        case 'last_css':
        ...
        case 'sceditor_js':
            return "{$site_config['paths']['baseurl']}/js/1/sceditor_a580c5b0.js";
        case 'cheaters_js':
