...
function get_file_name($file)
{
    ...
    switch ($file) {
        ...
        case 'sceditor_css':
            return "{$site_config['paths']['baseurl']}/css/1/sceditor_172a58a5.css";
        case 'main_css':
            return "{$site_config['paths']['baseurl']}/css/1/main_6de2cdf4.css";
        case 'last_css':
        ...
        case 'sceditor_js':
            return "{$site_config['paths']['baseurl']}/js/1/sceditor_4ecb4a88.js";
        case 'cheaters_js':
