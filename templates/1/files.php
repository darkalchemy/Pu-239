...
function get_file_name($file)
{
    ...
    switch ($file) {
        ...
        case 'css':
            return "{$site_config['baseurl']}/css/1/css_6cf90d0e.css";
        case 'vendor_css':
            return "{$site_config['baseurl']}/css/1/vendor_0adb4a45.css";
        case 'sceditor_css':
            return "{$site_config['baseurl']}/css/1/sceditor_61ac2459.css";
        case 'main_css':
            return "{$site_config['baseurl']}/css/1/main_71bc0a61.css";
        case 'main_js':
            return "{$site_config['baseurl']}/js/1/main_0ee654d8.js";
        case 'vendor_js':
        ...
        case 'bookmarks_js':
            return "{$site_config['baseurl']}/js/1/bookmarks_0673fe80.js";
        case 'iframe_js':
        ...
        case 'sceditor_js':
            return "{$site_config['baseurl']}/js/1/sceditor_596a382a.js";
        case 'cheaters_js':
        ...
        case 'details_js':
            return "{$site_config['baseurl']}/js/1/details_f136860e.js";
        case 'forums_js':
