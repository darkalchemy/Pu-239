...
function get_file_name($file)
{
    ...
    switch ($file) {
        ...
        case 'sceditor_css':
            return "{$site_config['paths']['baseurl']}/css/1/sceditor_fc80db4b.css";
        case 'main_css':
            return "{$site_config['paths']['baseurl']}/css/1/main_907c62e5.css";
        case 'last_css':
        ...
        case 'sceditor_js':
            return "{$site_config['paths']['baseurl']}/js/1/sceditor_bbdc6292.js";
        case 'cheaters_js':
