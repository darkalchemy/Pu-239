...
function get_file_name($file)
{
    ...
    switch ($file) {
        ...
        case 'sceditor_css':
            return "{$site_config['paths']['baseurl']}/css/1/sceditor_4a761807.css";
        case 'main_css':
            return "{$site_config['paths']['baseurl']}/css/1/main_a9ee7e03.css";
        case 'main_js':
        ...
        case 'sceditor_js':
            return "{$site_config['paths']['baseurl']}/js/1/sceditor_56284563.js";
        case 'cheaters_js':
