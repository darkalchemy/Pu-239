...
function get_file_name($file)
{
    ...
    switch ($file) {
        ...
        case 'sceditor_css':
            return "{$site_config['baseurl']}/css/2/sceditor_05975556.css";
        case 'main_css':
            return "{$site_config['baseurl']}/css/2/main_6ab04753.css";
        case 'main_js':
        ...
        case 'sceditor_js':
            return "{$site_config['baseurl']}/js/2/sceditor_001d36d5.js";
        case 'cheaters_js':
