...
function get_file_name($file)
{
    ...
    switch ($file) {
        ...
        case 'css':
            return "{$site_config['paths']['baseurl']}/css/2/css_eeb2cb65.css";
        case 'vendor_css':
        ...
        case 'sceditor_css':
            return "{$site_config['paths']['baseurl']}/css/2/sceditor_241a2a57.css";
        case 'main_css':
        ...
        case 'cookieconsent_js':
            return "{$site_config['paths']['baseurl']}/js/2/cookieconsent_68ccc5d7.js";
        case 'bookmarks_js':
        ...
        case 'sceditor_js':
            return "{$site_config['paths']['baseurl']}/js/2/sceditor_ea3ba4f4.js";
        case 'cheaters_js':
