...
$genres = [
    ...
    'movie' => ['Action', 'Adult', 'Adventure', 'Comedy', 'Documentary', 'Drame', 'Family', 'Horror', 'Thriller', 'Sci-fi'],
    'tv' => ['Action', 'Adult', 'Adventure', 'Comedy', 'Documentary', 'Drame', 'Family', 'Horror', 'Thriller', 'Sci-fi'],
    'music' => ['Hip Hop', 'Rock', 'Pop', 'House', 'Techno', 'Commercial'],
    'game' => ['FPS', 'Strategy', 'Adventure', '3rd Person', 'Acton'],
    'apps' => ['Burning', 'Encoding', 'Anti-Virus', 'Office', 'OS', 'Misc', 'Image'],
    'none' => ['None'],
];
