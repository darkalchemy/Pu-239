...
$lang = [
    ...
    'login_pin'           => 'PIN:',
    'login_login'         => 'Log in!',
    'login_signup'        => "<a href='./signup.php' class='btn'>Join us</a>!",
    'login_login_btn'     => 'Login',
    'login_open'          => 'Signup is open',
    'login_open1'         => "Signup is open <a href='./signup.php' class='btn'>Join us</a>!",
    'login_forgot'        => "<a href='./resetpw.php' class='btn'>Forgot Password</a>!",
    'login_forgot_1'      => "<a href='./resetpw.php' class='btn'>Forgot password?</a>",
