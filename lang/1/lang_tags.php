...
$lang = [
    ...
    'tags_tags' => 'Tags',
    'tags_title' => "The {$site_config['site']['name']} forums supports a number of <i>BB tags</i> which you can embed to modify how your posts are displayed.",
    ...
    'tags_image4' => '[img=' . $site_config['paths']['images_baseurl'] . 'logo.gif]',
    ...
    'tags_image9' => '[img]' . $site_config['paths']['images_baseurl'] . 'logo.gif[/img]',
