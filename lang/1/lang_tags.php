...
$lang = [
    ...
    'tags_tags'        => 'Tags',
    'tags_title'       => "<p>The {$site_config['site_name']} forums supports a number of <i>BB tags</i> which you can embed to modify how your posts are displayed.</p>",
    ...
    'tags_hyper4'      => '[url]' . $site_config['baseurl'] . '/[/url]',
    ...
    'tags_hyper9'      => '[url=' . $site_config['baseurl'] . '/]' . $site_config['site_name'] . '[/url]',
    ...
    'tags_image4'      => '[img=' . $site_config['baseurl'] . '/images/logo.gif]',
    ...
    'tags_image9'      => '[img]' . $site_config['baseurl'] . '/images/logo.gif[/img]',
