...
$lang = [
    ...
    'login_pin' => 'PIN:',
    'login_login' => 'Log in!',
    'login_signup' => "<a href='{$site_config['paths']['baseurl']}/signup.php' class='altlink'>Join us!</a>",
    'login_login_btn' => 'Login',
    'login_open' => 'Signup is open',
    'login_open1' => "Signup is open <a href='{$site_config['paths']['baseurl']}/signup.php' class='altlink'>Join us!</a>",
    'login_forgot_1' => "<a href='{$site_config['paths']['baseurl']}/recover.php' class='altlink'>Mail recover?</a>",
