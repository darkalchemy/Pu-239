...
if (count($list) > 0) {
    ...
    foreach ($player_cards as $card) {
        ...
        if ($card != $player_cards[0]) {
            ...
            $player_showcards .= "<img src='{$INSTALLER09['pic_base_url']}cards/back.png' width='71' height='97' border='0' alt='' alt='{$lang['bj_cards']}' title='{$lang['bj_cards']}' class='tooltipper tooltipper_img' />";
        }
    ...
    if ($_POST['game'] == 'hit') {
        if ($start_ == 'yes') {
            ...
            if (!$dealer) {
                ...
                $player_showcards .= "<div class='card {$card_details['pic']}'></div>";
                $player_showcards_end = $player_showcards;
            } else {
    ...
    if (count($bjgames) > 0) {
        ...
        foreach ($bjgames as $bjgame) {
            ...
            foreach ($cards_a as $card_a) {
                ...
                $HTMLOUT .= "<div class='card {$cardarr['pic']}'></div>";
            }
            $HTMLOUT .= "
                                            </td>
                                            <td class='text-center' style='width:50%;'>";
