...
CREATE TABLE `announcement_main` (
  ...
  `sql_query` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `avps` (
  ...
  `value_s` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `bugs` (
  ...
  `problem` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `cards` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `points` int(10) unsigned NOT NULL DEFAULT 0,
  `pic` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cleanup` (
  ...
  `clean_desc` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `comments` (
  ...
  `added` int(10) unsigned NOT NULL DEFAULT 0,
  `text` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ori_text` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `events` (
  ...
  `overlayText` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `forum_poll` (
  ...
  `poll_answers` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `messages` (
  ...
  `msg` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `poll` (
  ...
  `answers` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `posts` (
  ...
  `post_history` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `reports` (
  ...
  `added` int(10) unsigned NOT NULL DEFAULT 0,
  `how_delt_with` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `torrents` (
  ...
  `search_text` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `descr` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ori_descr` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `category` int(10) unsigned NOT NULL DEFAULT 0,
  `size` bigint(20) unsigned NOT NULL DEFAULT 0,
  `added` int(10) unsigned NOT NULL DEFAULT 0,
  ...
  `num_ratings` int(10) unsigned NOT NULL DEFAULT 0,
  `rating_sum` int(10) unsigned NOT NULL DEFAULT 0,
  `nfo` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `uploadapp` (
  ...
  `offer` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `modcomment` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `anonymous` enum('yes','no') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'no',
  `uploadpos` int(10) unsigned NOT NULL DEFAULT 0,
  `forumpost` int(10) unsigned NOT NULL DEFAULT 0,
  `downloadpos` int(10) unsigned NOT NULL DEFAULT 0,
  `immunity` int(10) unsigned NOT NULL DEFAULT 0,
  `leechwarn` int(10) unsigned NOT NULL DEFAULT 0,
  `disable_reason` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `avatarpos` int(10) unsigned NOT NULL DEFAULT 0,
  `support` enum('yes','no') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'no',
  `supportfor` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `language_new` int(10) unsigned NOT NULL DEFAULT 0,
  `sendpmpos` int(10) unsigned NOT NULL DEFAULT 0,
  ...
  `warn_reason` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `browser` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `hits` int(10) NOT NULL DEFAULT 0,
  `comments` int(10) unsigned NOT NULL DEFAULT 0,
  ...
  `watched_user_reason` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `staff_notes` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `game_access` int(10) unsigned NOT NULL DEFAULT 0,
  `where_is` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `use_12_hour` enum('yes','no') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'yes',
  PRIMARY KEY (`id`),
...
CREATE TABLE `ustatus` (
  ...
  `archive` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `userid` (`userid`),
...
-- Dump completed on 2018-10-31  7:07:08
