...
CREATE TABLE `ajax_chat_bans` (
  ...
  CONSTRAINT `ajax_chat_bans_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `ajax_chat_invitations` (
  ...
  KEY `dateTime` (`dateTime`),
  CONSTRAINT `ajax_chat_invitations_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `ajax_chat_messages` (
  ...
  CONSTRAINT `ajax_chat_messages_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `ajax_chat_messages_ibfk_2` FOREIGN KEY (`userName`) REFERENCES `users` (`username`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `ajax_chat_online` (
  ...
  PRIMARY KEY (`userID`),
  KEY `userName` (`userName`),
  CONSTRAINT `ajax_chat_online_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `announcement_main` (
  ...
  CONSTRAINT `announcement_main_ibfk_1` FOREIGN KEY (`owner_id`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `announcement_process` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `announcement_process_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `blackjack` (
  ...
  KEY `ddown` (`ddown`),
  KEY `game_id` (`game_id`),
  CONSTRAINT `blackjack_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `blackjack_history` (
  ...
  CONSTRAINT `blackjack_history_ibfk_1` FOREIGN KEY (`player1_userid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `blackjack_history_ibfk_2` FOREIGN KEY (`player2_userid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `blocks` (
  ...
  PRIMARY KEY (`id`),
  KEY `userid` (`userid`),
  CONSTRAINT `blocks_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `bonus` (
  ...
  COMMENT 'This will determined a switch if the bonus is enabled or not! enabled by default',
...
CREATE TABLE `bonuslog` (
  ...
  COLLATE = utf8mb4_unicode_ci
  ROW_FORMAT = DYNAMIC
  COMMENT = 'log of contributors towards freeleech etc...';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `bookmarks` (
  ...
  CONSTRAINT `bookmarks_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `bookmarks_ibfk_2` FOREIGN KEY (`torrentid`) REFERENCES `torrents` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `casino` (
  ...
  PRIMARY KEY (`userid`),
  CONSTRAINT `casino_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `casino_bets` (
  ...
  PRIMARY KEY (`id`),
  KEY `userid` (`userid`),
  CONSTRAINT `casino_bets_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `cheaters` (
  ...
  PRIMARY KEY (`id`),
  KEY `userid` (`userid`),
  CONSTRAINT `cheaters_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `coins` (
  ...
  KEY `torrentid` (`torrentid`),
  KEY `userid` (`userid`),
  CONSTRAINT `coins_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `files` (
  ...
  CONSTRAINT `files_ibfk_1` FOREIGN KEY (`torrent`) REFERENCES `torrents` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `flashscores` (
  ...
  KEY `user` (`user_id`),
  KEY `score` (`score`),
  CONSTRAINT `flashscores_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `forum_poll` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `forum_poll_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `forum_poll_votes` (
  ...
  KEY `poll_id` (`poll_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `forum_poll_votes_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `freeslots` (
  ...
  KEY `userid` (`userid`),
  KEY `torrentid` (`torrentid`),
  CONSTRAINT `freeslots_ibfk_1` FOREIGN KEY (`torrentid`) REFERENCES `torrents` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `freeslots_ibfk_2` FOREIGN KEY (`userid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `funds` (
  ...
  PRIMARY KEY (`id`),
  KEY `user` (`user`),
  CONSTRAINT `funds_ibfk_1` FOREIGN KEY (`user`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `happyhour` (
  ...
  KEY `userid` (`userid`),
  KEY `torrentid` (`torrentid`),
  CONSTRAINT `happyhour_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `happyhour_ibfk_2` FOREIGN KEY (`torrentid`) REFERENCES `torrents` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `happylog` (
  ...
  KEY `userid` (`userid`),
  KEY `torrentid` (`torrentid`),
  CONSTRAINT `happylog_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `happylog_ibfk_2` FOREIGN KEY (`torrentid`) REFERENCES `torrents` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `highscores` (
  ...
  KEY `user` (`user_id`),
  KEY `score` (`score`),
  CONSTRAINT `highscores_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `invite_codes` (
  ...
  PRIMARY KEY (`id`),
  KEY `sender` (`sender`),
  CONSTRAINT `invite_codes_ibfk_1` FOREIGN KEY (`sender`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `ips` (
  ...
  `lastannounce` int(10) unsigned                                                        NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `ip_userid_type` (`ip`, `userid`, `type`),
  KEY `userid` (`userid`),
  KEY `ip` (`ip`),
  CONSTRAINT `ips_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `messages` (
  ...
  KEY `added` (`added`),
  KEY `location_added` (`location`, `added`),
...
CREATE TABLE `notconnectablepmlog` (
  ...
  PRIMARY KEY (`id`),
  KEY `user` (`user`),
  CONSTRAINT `notconnectablepmlog_ibfk_1` FOREIGN KEY (`user`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `now_viewing` (
  ...
  KEY `added` (`added`),
  CONSTRAINT `now_viewing_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `offer_votes` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `offer_votes_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `offers` (
  ...
  CONSTRAINT `offers_ibfk_1` FOREIGN KEY (`offered_by_user_id`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `peers` (
  ...
  KEY `seeder` (`seeder`),
  KEY `peer_id` (`peer_id`),
  CONSTRAINT `peers_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `peers_ibfk_2` FOREIGN KEY (`torrent`) REFERENCES `torrents` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `pmboxes` (
  ...
  PRIMARY KEY (`id`),
  KEY `userid` (`userid`),
  CONSTRAINT `pmboxes_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `poll_voters` (
  ...
  KEY `poll_id` (`poll_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `poll_voters_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `rating` (
  ...
  KEY `user` (`user`),
  KEY `torrent` (`torrent`),
  CONSTRAINT `rating_ibfk_1` FOREIGN KEY (`user`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `reputation` (
  ...
  KEY `dateadd` (`dateadd`),
  KEY `locale` (`locale`),
  CONSTRAINT `reputation_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `reputation_ibfk_2` FOREIGN KEY (`whoadded`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `request_votes` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `request_votes_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `requests` (
  ...
  CONSTRAINT `requests_ibfk_1` FOREIGN KEY (`requested_by_user_id`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `shit_list` (
  ...
  `text`       mediumtext COLLATE utf8mb4_unicode_ci,
  KEY `userid` (`userid`),
  CONSTRAINT `shit_list_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `snatched` (
  ...
  KEY `torrentid` (`torrentid`),
  CONSTRAINT `snatched_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `snatched_ibfk_2` FOREIGN KEY (`torrentid`) REFERENCES `torrents` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `staffmessages` (
  ...
  KEY `sender` (`sender`),
  CONSTRAINT `staffmessages_ibfk_1` FOREIGN KEY (`sender`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `subtitles` (
  ...
  KEY `id` (`id`),
  KEY `owner` (`owner`),
  CONSTRAINT `subtitles_ibfk_1` FOREIGN KEY (`owner`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `thanks` (
  ...
  KEY `userid` (`userid`),
  KEY `torrentid` (`torrentid`),
  CONSTRAINT `thanks_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `thanks_ibfk_2` FOREIGN KEY (`torrentid`) REFERENCES `torrents` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `thankyou` (
  ...
  KEY `uid` (`uid`),
  KEY `torid` (`torid`),
  CONSTRAINT `thankyou_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `thankyou_ibfk_2` FOREIGN KEY (`torid`) REFERENCES `torrents` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `triviausers` (
  ...
  CONSTRAINT `triviausers_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `triviausers_ibfk_3` FOREIGN KEY (`gamenum`) REFERENCES `triviasettings` (`gamenum`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `triviausers_ibfk_4` FOREIGN KEY (`qid`) REFERENCES `triviaq` (`qid`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `uploadapp` (
  ...
  KEY `status` (`status`),
  CONSTRAINT `uploadapp_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `user_blocks` (
  ...
  CONSTRAINT `user_blocks_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `usercomments` (
  ...
  KEY `user` (`user`),
  KEY `userid` (`userid`),
  CONSTRAINT `usercomments_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `userhits` (
  ...
  KEY `added` (`added`),
  KEY `hitid` (`hitid`),
  CONSTRAINT `userhits_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `users` (
  ...
  `use_12_hour`            tinyint(1) unsigned                                         NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `usersachiev` (
  ...
  CONSTRAINT `usersachiev_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `ustatus` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `userid` (`userid`),
  CONSTRAINT `ustatus_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
