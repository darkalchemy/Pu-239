...
$checkbox_index_christmasgift = ((curuser::$blocks['index_page'] & block_index::CHRISTMAS_GIFT) ? ' checked="checked"' : '');
...
$HTMLOUT .= '
 <div class="container"><form action="" method="post">
        ...
        <div class="row-fluid">
        <!--    <div class="toggle-slide toggle-select active"><div class="toggle-inner"><div class="toggle-on active">ON</div><div class="toggle-blob"></div><div class="toggle-off">OFF</div></div></div>
Slide THREE -->
    ...
    <!--<div class="example select">
        <h4>Select Type</h4>
        <div class="toggle toggle-select" data-type="select">
        ...
        <div class="slideThree">
        <input type="checkbox" id="slideThree1" name="ajaxchat" value="yes"' . $checkbox_index_ajaxchat . ' />
