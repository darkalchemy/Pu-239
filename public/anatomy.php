...
<p class='text-black'>
    GET /announce.php?<span class='text-lightblue'>info_hash=c9791C5jG951BEC7MF9BFa03F22CEDEE0F</span>&amp;<span class='text-orange'>peer_id=S588-----gqQ8TqDeqaY</span>&amp;
...
<ul class='disc left20'>
    ...
    <li class='text-lightgreen'>
        downloaded=0
    </li>
    <li class='text-jade'>
        left=753690875 (how much left)
    </li>
    <li class='text-turquoise'>
...
<p class='text-black'>
    ...
    <span class='text-yellow'>uploaded=67960832</span>&amp;<span class='text-green'>downloaded=40828928</span>&amp;left=715417851&amp;<span class='text-turquoise'>numwant=0</span>
</p>
<ul class='disc left20'>
    <li class='text-turquoise'>
...
<p class='text-black'>
    GET /announce.php?info_hash=c9791C5jG951BEC7MF9BFa03F22CEDEE0F&amp;peer_id=S588-----gqQ8TqDeqaY&amp;port=6882&amp;uploaded=754384896&amp;downloaded=754215163&amp;<span class='text-jade'>left=0&amp;numwant=0&amp;
    <span class='text-turquoise'>event=completed</span>
</p>
<p>
    Notice the all-important <span class='text-turquoise'>'event=completed'</span>. It is at this stage that the torrent will be removed from the user's profile. If for some reason (tracker down, lost connection, bad client, crash, ...) this last GET doesn't reach the tracker and this torrent will still be seen in the user profile until some tracker timeout occurs. It should be stressed that this message will be sent only when closing the client properly, not when the download is finished. (The tracker will start listing a torrent as 'currently seeding' after it receives a GET with <span class='text-jade'>left=0</span>).
</p>
<p>
    There's a further message that causes the torrent to be removed from the user's profile, namely <span class='text-turquoise'>'event=stopped'</span>. This is usually sent when stopping in the middle of a download, e.g. by pressing 'Cancel'.
</p>
<p>
