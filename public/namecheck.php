...
if ($numbers > 0) {
    while ($namecheck = mysqli_fetch_assoc($result)) {
        $HTMLOUT .= "<font color='#cc0000'><img src='{$site_config['pic_base_url']}cross.png' alt='Cross' title='Username  Not Available' align='absmiddle' /><b>Sorry... Username - " . htmlsafechars($namecheck['username']) . ' is already in use.</b></font>';
    }
} else {
    $HTMLOUT .= "<font color='#33cc33'><img src='{$site_config['pic_base_url']}tick.png' alt='Tick' title='Username Available' align='absmiddle' /><b>Username Available</b></font>";
}
echo $HTMLOUT;
exit();
