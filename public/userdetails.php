...
$HTMLOUT .= "
        <div id='tabs' class='widget'>
            <ul class='flex-grid'>
                <li class='$flex_cell'><a href='#torrents'>{$lang['userdetails_torrents']}</a></li>
...
if (($CURUSER['class'] >= UC_STAFF && $user['class'] < $CURUSER['class']) || $CURUSER['class'] === UC_MAX) {
    ...
    <td colspan='2' class='text-left'><input name='signature_post' value='yes' type='radio'" . ($user['signature_post'] == 'yes' ? "    checked='checked'" : '') . " />{$lang['userdetails_yes']}
   ...
   <td colspan='2' class='text-left'><input name='signatures' value='yes' type='radio'" . ($user['signatures'] == 'yes' ? " checked='checked'" : '') . " />{$lang['userdetails_yes']}
   <input name='signatures' value='no' type='radio'" . ($user['signatures'] == 'no' ? " checked='checked'" : '') . " /></td>
               ...
               <tr>
                      ...
                      <td colspan='2' class='text-left'><textarea cols='60' rows='2' name='signature'>" . htmlsafechars($user['signature']) . "</textarea></td>
                </tr>

                <tr>
                      <td class='rowhead'>{$lang['userdetails_gtalk']}</td>
                      <td colspan='2' class='text-left'><input type='text' size='60' name='google_talk' value='" . htmlsafechars($user['google_talk']) . "' /></td>
                </tr>
                <tr>
                      <td class='rowhead'>{$lang['userdetails_msn']}</td>
                      <td colspan='2' class='text-left'><input type='text' size='60' name='msn' value='" . htmlsafechars($user['msn']) . "' /></td>
                </tr>
                <tr>
                      <td class='rowhead'>{$lang['userdetails_aim']}</td>
                      <td colspan='2' class='text-left'><input type='text' size='60' name='aim' value='" . htmlsafechars($user['aim']) . "' /></td>
                </tr>
                <tr>
                      <td class='rowhead'>{$lang['userdetails_yahoo']}</td>
                      <td colspan='2' class='text-left'><input type='text' size='60' name='yahoo' value='" . htmlsafechars($user['yahoo']) . "' /></td>
                </tr>
                <tr>
                      <td class='rowhead'>{$lang['userdetails_icq']}</td>
                      <td colspan='2' class='text-left'><input type='text' size='60' name='icq' value='" . htmlsafechars($user['icq']) . "' /></td>
                </tr>
                <tr>
                      <td class='rowhead'>{$lang['userdetails_website']}</td>
                      <td colspan='2' class='text-left'><input type='text' size='60' name='website' value='" . htmlsafechars($user['website']) . "' /></td>
                </tr>";
    //== we do not want mods to be able to change user classes or amount donated...
    // === Donor mod time based by snuggles
    if ($CURUSER['class'] == UC_MAX) {
        $donor = $user['donor'] == 'yes';
        $HTMLOUT .= "<tr><td class='rowhead' class='text-right'><b>{$lang['userdetails_donor']}</b></td><td colspan='2' class='text-center'>";
        if ($donor) {
    ...
    //$HTMLOUT.= "<tr><td class='rowhead'>{$lang['userdetails_support']}</td><td colspan='2' class='text-left'><input type='checkbox' name='support' value='yes'" . (($user['opt1'] & user_options::SUPPORT) ? " checked='checked'" : "") . " />{$lang['userdetails_yes']}</td></tr>\n";
    $HTMLOUT .= "<tr><td class='rowhead'>{$lang['userdetails_support']}</td><td colspan='2' class='text-left'><input type='radio' name='support' value='yes'" . ($user['support'] == 'yes' ? " checked='checked'" : '') . " />{$lang['userdetails_yes']}<input type='radio' name='support' value='no'" . ($user['support'] == 'no' ? " checked='checked'" : '') . " />{$lang['userdetails_no']}</td></tr>\n";
    $HTMLOUT .= "<tr><td class='rowhead'>{$lang['userdetails_supportfor']}</td><td colspan='2' class='text-left'><textarea cols='60' rows='2' name='supportfor'>{$supportfor}</textarea></td></tr>\n";
    $modcomment = htmlsafechars($user_stats['modcomment']);
    if ($CURUSER['class'] < UC_SYSOP) {
        $HTMLOUT .= "<tr><td class='rowhead'>{$lang['userdetails_comment']}</td><td colspan='2' class='text-left'><textarea cols='60' rows='6' name='modcomment' readonly='readonly'>$modcomment</textarea></td></tr>\n";
    } else {
        $HTMLOUT .= "<tr><td class='rowhead'>{$lang['userdetails_comment']}</td><td colspan='2' class='text-left'><textarea cols='60' rows='6' name='modcomment'>$modcomment</textarea></td></tr>\n";
    }
    ...
    if ($CURUSER['class'] >= UC_STAFF && XBT_TRACKER == false) {
        $HTMLOUT .= "<tr><td class='rowhead'>{$lang['userdetails_freeleech_slots']}</td><td colspan='2' class='text-left'>
    ...
    if ($CURUSER['class'] >= UC_ADMINISTRATOR && XBT_TRACKER == false) {
        ...
        if ($free_switch) {
         ...
         <tr><td colspan="2" class="text-left">' . $lang['userdetails_pm_comment'] . ':<input type="text" size="60" name="free_pm" /></td></tr>';
        }
    }
    //==XBT - Can Leech
    if (XBT_TRACKER == true) {
        $HTMLOUT .= "<tr><td class='rowhead'>{$lang['userdetails_canleech']}</td><td class='row' colspan='2' class='text-left'><input type='radio' name='can_leech' value='1' " . ($user['can_leech'] == 1 ? " checked='checked'" : '') . " />{$lang['userdetails_yes']} <input type='radio' name='can_leech' value='0' " . ($user['can_leech'] == 0 ? " checked='checked'" : '') . " />{$lang['userdetails_no']}</td></tr>\n";
    }
    //==Download disable
    if ($CURUSER['class'] >= UC_STAFF && XBT_TRACKER == false) {
        ...
        <tr><td colspan="2" class="text-left">' . $lang['userdetails_pm_comment'] . ':<input type="text" size="60" name="disable_pm" /></td></tr>';
        }
    }
    //==Upload disable
    if ($CURUSER['class'] >= UC_STAFF) {
        ...
        <tr><td colspan="2" class="text-left">' . $lang['userdetails_pm_comment'] . ':<input type="text" size="60" name="updisable_pm" /></td></tr>';
        }
    }
    //==
    //==Pm disable
    if ($CURUSER['class'] >= UC_STAFF) {
        ...
        <tr><td colspan="2" class="text-left">' . $lang['userdetails_pm_comment'] . ':<input type="text" size="60" name="pmdisable_pm" /></td></tr>';
        }
    }
    //==AJAX Chat disable
    if ($CURUSER['class'] >= UC_STAFF) {
        ...
        <tr><td colspan="2" class="text-left">' . $lang['userdetails_pm_comment'] . ':<input type="text" size="60" name="chatdisable_pm" /></td></tr>';
        }
    }
    //==Avatar disable
    if ($CURUSER['class'] >= UC_STAFF) {
        ...
        <tr><td colspan="2" class="text-left">' . $lang['userdetails_pm_comment'] . ':<input type="text" size="60" name="avatardisable_pm" /></td></tr>';
        }
    }
    //==Immunity
    if ($CURUSER['class'] >= UC_STAFF) {
        ...
        <tr><td colspan="2" class="text-left">' . $lang['userdetails_pm_comment'] . ':<input type="text" size="60" name="immunity_pm" /></td></tr>';
        }
    }
    //==End
    //==Leech Warnings
    if ($CURUSER['class'] >= UC_STAFF) {
        ...
        <tr><td colspan="2" class="text-left">' . $lang['userdetails_pm_comment'] . ':<input type="text" size="60" name="leechwarn_pm" /></td></tr>';
        }
    }
    //==End
    //==Warnings
    if ($CURUSER['class'] >= UC_STAFF) {
        ...
        <tr><td colspan="2" class="text-left">' . $lang['userdetails_pm_comm'] . '<input type="text" size="60" name="warned_pm" /></td></tr>';
        }
    }
    //==End
    //==Games disable
    if ($CURUSER['class'] >= UC_STAFF) {
        ...
        <tr><td colspan="2" class="text-left">' . $lang['userdetails_pm_comment'] . ':<input type="text" size="60" name="game_disable_pm" /></td></tr>';
        }
    }
    if (XBT_TRACKER == true) {
        // == Wait time
        if ($CURUSER['class'] >= UC_STAFF) {
            $HTMLOUT .= "<tr><td class='rowhead'>{$lang['userdetails_waittime']}</td><td colspan='2' class='text-left'><input type='text' size='6' name='wait_time' value='" . (int)$user['wait_time'] . "' /></td></tr>";
        }
        // ==end
        // == Peers limit
        if ($CURUSER['class'] >= UC_STAFF) {
            $HTMLOUT .= "<tr><td class='rowhead'>{$lang['userdetails_peerslimit']}</td><td colspan='2' class='text-left'><input type='text' size='6' name='peers_limit' value='" . (int)$user['peers_limit'] . "' /></td></tr>";
        }
        // ==end
        // == Torrents limit
        if ($CURUSER['class'] >= UC_STAFF) {
            $HTMLOUT .= "<tr><td class='rowhead'>{$lang['userdetails_torrentslimit']}</td><td colspan='2' class='text-left'><input type='text' size='6' name='torrents_limit' value='" . (int)$user['torrents_limit'] . "' /></td></tr>";
        }
        // ==end
    }
    //==High speed
    if ($CURUSER['class'] == UC_MAX && XBT_TRACKER == false) {
        //$HTMLOUT.= "<tr><td class='rowhead'>{$lang['userdetails_highspeed']}</td><td class='row' colspan='2' class='text-left'><input type='checkbox' name='highspeed' value='yes'" . (($user['opt1'] & user_options::HIGHSPEED) ? " checked='checked'" : "") . " />Yes</td></tr>\n";
        $HTMLOUT .= "<tr><td class='rowhead'>{$lang['userdetails_highspeed']}</td><td class='row' colspan='2' class='text-left'><input type='radio' name='highspeed' value='yes' " . ($user['highspeed'] == 'yes' ? " checked='checked'" : '') . " />{$lang['userdetails_yes']} <input type='radio' name='highspeed' value='no' " . ($user['highspeed'] == 'no' ? " checked='checked'" : '') . " />{$lang['userdetails_no']}</td></tr>\n";
    }
    //$HTMLOUT.= "<tr><td class='rowhead'>{$lang['userdetails_park']}</td><td colspan='2' class='text-left'><input name='parked' value='yes' type='checkbox'" . (($user['opt1'] & user_options::PARKED) ? " checked='checked'" : "") . " />{$lang['userdetails_yes']}</td></tr>\n";
    $HTMLOUT .= "<tr><td class='rowhead'>{$lang['userdetails_park']}</td><td colspan='2' class='text-left'><input name='parked' value='yes' type='radio'" . ($user['parked'] == 'yes' ? " checked='checked'" : '') . " />{$lang['userdetails_yes']} <input name='parked' value='no' type='radio'" . ($user['parked'] == 'no' ? " checked='checked'" : '') . " />{$lang['userdetails_no']}</td></tr>\n";
    ...
    // == seedbonus
    if ($CURUSER['class'] >= UC_STAFF) {
        $HTMLOUT .= "<tr><td class='rowhead'>{$lang['userdetails_bonus_points']}</td><td colspan='2' class='text-left'><input type='text' size='6' name='seedbonus' value='" . (int)$user_stats['seedbonus'] . "' /></td></tr>";
    }
    // ==end
    // == rep
    if ($CURUSER['class'] >= UC_STAFF) {
        $HTMLOUT .= "<tr><td class='rowhead'>{$lang['userdetails_rep_points']}</td><td colspan='2' class='text-left'><input type='text' size='6' name='reputation' value='" . (int)$user['reputation'] . "' /></td></tr>";
    }
    // ==end
    //==Invites
    $HTMLOUT .= "<tr><td class='rowhead'>{$lang['userdetails_invright']}</td><td colspan='2' class='text-left'><input type='radio' name='invite_on' value='yes'" . ($user['invite_on'] == 'yes' ? " checked='checked'" : '') . " />{$lang['userdetails_yes']}<input type='radio' name='invite_on' value='no'" . ($user['invite_on'] == 'no' ? " checked='checked'" : '') . " />{$lang['userdetails_no']}</td></tr>\n";
    //$HTMLOUT.= "<tr><td class='rowhead'>{$lang['userdetails_invright']}</td><td colspan='2' class='text-left'><input type='checkbox' name='invite_on' value='yes'" . (($user['opt1'] & user_options::INVITE_ON) ? " checked='checked'" : "") . " />{$lang['userdetails_yes']}</td></tr>\n";
    $HTMLOUT .= "<tr><td class='rowhead'><b>{$lang['userdetails_invites']}</b></td><td colspan='2' class='text-left'><input type='text' size='3' name='invites' value='" . htmlsafechars($user['invites']) . "' /></td></tr>\n";
    /*$HTMLOUT.= "<tr>
                      <td class='rowhead'>Avatar Rights</td>
                      <td colspan='2' class='text-left'><input name='view_offensive_avatar' value='yes' type='checkbox'" . (($user['opt1'] & user_options::VIEW_OFFENSIVE_AVATAR) ? " checked='checked'" : "") . " />Yes</td>
                </tr>
                <tr>
                      <td class='rowhead'>Offensive Avatar</td>
                      <td colspan='2' class='text-left'><input name='offensive_avatar' value='yes' type='checkbox'" . (($user['opt1'] & user_options::OFFENSIVE_AVATAR) ? " checked='checked'" : "") . " />Yes</td>
                </tr>
                <tr>
                      <td class='rowhead'>View Offensive Avatars</td>
                      <td colspan='2' class='text-left'><input name='avatar_rights' value='yes' type='checkbox'" . (($user['opt1'] & user_options::AVATAR_RIGHTS) ? " checked='checked'" : "") . " />Yes</td>
                </tr>";*/
    $HTMLOUT .= "<tr>
                  <td class='rowhead'>{$lang['userdetails_avatar_rights']}</td>
                  <td colspan='2' class='text-left'><input name='view_offensive_avatar' value='yes' type='radio'" . ($user['view_offensive_avatar'] == 'yes' ? " checked='checked'" : '') . " />{$lang['userdetails_yes']}
                 ...
                 <tr>
                  ...
                  <td colspan='2' class='text-left'><input name='offensive_avatar' value='yes' type='radio'" . ($user['offensive_avatar'] == 'yes' ? " checked='checked'" : '') . " />{$lang['userdetails_yes']}
                ...
                <tr>
                  ...
                  <td colspan='2' class='text-left'><input name='avatar_rights' value='yes' type='radio'" . ($user['avatar_rights'] == 'yes' ? " checked='checked'" : '') . " />{$lang['userdetails_yes']}
    ...
    $HTMLOUT .= '<tr>
                      ...
                      <td colspan="2" class="text-left"><input type="text" size="3" name="hit_and_run_total" value="' . (int)$user['hit_and_run_total'] . '" /></td>
                </tr>
                 <tr>
                     <td class="rowhead">' . $lang['userdetails_suspended'] . '</td>
                     <td colspan="2" class="text-left"><input name="suspended" value="yes" type="radio"' . ($user['suspended'] == 'yes' ? ' checked="checked"' : '') . ' />' . $lang['userdetails_yes'] . '
...
&#160;&#160;&#160;&#160;&#160;&#160;&#160; ' . $lang['userdetails_suspended_reason'] . '<br>
                ...
                <!--<tr>
                      <td class="rowhead">' . $lang['userdetails_suspended'] . '</td>
                      <td colspan="2" class="text-left"><input name="suspended" value="yes" type="checkbox"' . (($user['opt1'] & user_options::SUSPENDED) ? ' checked="checked"' : '') . ' />' . $lang['userdetails_yes'] . '
                      &#160;&#160;&#160;&#160;&#160;&#160;&#160; ' . $lang['userdetails_suspended_reason'] . '<br>
                      <input type="text" size="60" name="suspended_reason" /></td>
                </tr>-->
      ';
    $HTMLOUT .= "<tr>
                 ...
                 <tr>
                     ...
                     <td colspan='2' class='text-left'><input name='forum_post' value='yes' type='radio'" . ($user['forum_post'] == 'yes' ? " checked='checked'" : '') . " />{$lang['userdetails_yes']}
                     <input name='forum_post' value='no' type='radio'" . ($user['forum_post'] == 'no' ? " checked='checked'" : '') . " />{$lang['userdetails_forums_no']}</td>
                    </tr>
                <!--<tr>
                      <td class='rowhead'>{$lang['userdetails_forum_rights']}</td>
                      <td colspan='2' class='text-left'><input name='forum_post' value='yes' type='checkbox'" . (($user['opt1'] & user_options::FORUM_POST) ? " checked='checked'" : '') . " />{$lang['userdetails_yes']}</td>
                </tr>-->";
    //Adjust up/down
