...
var arrowheadimg = [ "./images/dl.png", "./images/up.png" ];
...
if (window.addEventListener) window.addEventListener("load", initalizetooltip, false); else if (window.attachEvent) window.attachEvent("onload", initalizetooltip); else if (document.getElementById) window.onload = initalizetooltip;
