!function(a) {
    ...
    function l(a) {
        ...
        function f(a) {
            ...
            h(V, "Checking " + d + " is in range " + c + "-" + b), c > e && (e = c, h(V, "Set " + d + " to min value")), 
            e > b && (e = b, h(V, "Set " + d + " to max value")), U[d] = "" + e;
        }
        function g() {
            function b() {
                function a() {
        ...
        function H(a) {
            ...
            var d = a.split("#")[1] || "", e = decodeURIComponent(d), f = document.getElementById(e) || document.getElementsByName(e)[0];
        ...
        function O(a) {
            var b = !0;
            return P[a] || (b = !1, j(U.type + " No settings for " + a + ". Message was: " + T)), 
            b;
        }
        function Q() {
        ...
        "[iFrameResizerChild]Ready" === T ? Q() : k() ? (U = e(), V = R = U.id, P[V].loaded = !0, 
        !l() && O(V) && (h(V, "Received: " + T), D() && g() && N())) : i(V, "Ignored: " + T);
    }
    function m(a, b, c) {
        var d = null, e = null;
        if (P[a]) {
    ...
    function n(a) {
        var b = a.id;
        h(b, "Removing iFrame: " + b), a.parentNode && a.parentNode.removeChild(a), m(b, "closedCallback", b), 
        h(b, "--"), delete P[b];
    }
    function o(b) {
        null === M && (M = {
    ...
    function p(a) {
        null !== M && (window.scrollTo(M.x, M.y), h(a, "Set page position: " + M.x + "," + M.y), 
        q());
    }
    function q() {
        M = null;
    ...
    function s(a) {
        ...
        function c(b) {
            H || "0" !== a[b] || (H = !0, h(e, "Hidden iFrame detected, creating visibility listener"), 
            y());
        }
        function d(a) {
            b(a), c(a);
    ...
    function w(c, d) {
        ...
        function g(a) {
            return R = a, "" === a && (c.id = a = f(), G = (d || {}).log, R = a, h(a, "Added missing iframe ID: " + a + " (" + c.src + ")")), 
            a;
        }
        function i() {
            switch (h(x, "IFrame scrolling " + (P[x].scrolling ? "enabled" : "disabled") + " for " + x), 
            c.style.overflow = !1 === P[x].scrolling ? "hidden" : "auto", P[x].scrolling) {
              case !0:
                c.scrolling = "yes";
                break;
        ...
        function k() {
            ("number" == typeof P[x].bodyMargin || "0" === P[x].bodyMargin) && (P[x].bodyMarginV1 = P[x].bodyMargin, 
    ...
    function C() {
        b(window, "message", l), b(window, "resize", function() {
            z("resize");
        }), b(document, "visibilitychange", A), b(document, "-webkit-visibilitychange", A), 
    ...
    if ("undefined" != typeof window) {
        var F = 0, G = !1, H = !1, I = "message", J = I.length, K = "[iFrameSizer]", L = K.length, M = null, N = window.requestAnimationFrame, O = {
            max: 1,
            scroll: 1,
            bodyScroll: 1,
...
(function(a) {
    ...
    var bo = function(b) {
        if (a.vml) {
            ...
            i.title = "RaphaÃ«l Colour Picker", i.style.display = "none", h.doc.body.appendChild(i), 
            bo = bv(function(a) {
                i.style.color = a;
    ...
    a.getRGB = bv(function(b) {
        ...
        if (k) {
            ...
            if (k[5]) {
                ...
                (j[0].slice(-3) == "deg" || j[0].slice(-1) == "Â°") && (d /= 360), k[1].toLowerCase().slice(0, 4) == "hsba" && (h = Q(j[3])), 
            ...
            if (k[6]) {
                ...
                j[1].slice(-1) == "%" && (e *= 2.55), f = Q(j[2]), j[2].slice(-1) == "%" && (f *= 2.55), 
                (j[0].slice(-3) == "deg" || j[0].slice(-1) == "Â°") && (d /= 360), k[1].toLowerCase().slice(0, 4) == "hsla" && (h = Q(j[3])), 
                j[3] && j[3].slice(-1) == "%" && (h /= 100);
    ...
    z.prototype = A, A.constructor = z, a._engine.path = function(a, b) {
        ...
        this.bottom = this.top = null, (this.desc = q("desc")).appendChild(a._g.doc.createTextNode("Created with RaphaÃ«l " + a.version)), 
...
(function(g) {
    var o = function(a, d, c) {
        ...
        var e = g("#iCarousel-preloader", a), f = g("div", e);
        e.css({
        ...
        var h = c.timerPadding, l = c.timerDiameter, k = c.timerStroke;
        if (c.autoPlay && 1 < b.defs.total && "bar" != b.defs.timer) {
            var k = "360bar" == b.defs.timer ? c.timerStroke : 0, i = l + 2 * h + 2 * k, j = i, a = Raphael(b.iCarouselTimer[0], i, j), m = l / 2, d = {
                stroke: c.timerBg,
                "stroke-width": k + 2 * h
            }, o = {
                stroke: c.timerColor,
            ...
            a.customAttributes.arc = function(a, b) {
                var c = 1 * a, d = (90 - c) * Math.PI / 180, e = l / 2 + h + k, f = l / 2 + h + k, g = e + b * Math.cos(d), d = f - b * Math.sin(d);
                return {
                    path: 360 == a ? [ [ "M", e, f - b ], [ "A", b, b, 0, 1, 1, 299.99, f - b ] ] : [ [ "M", e, f - b ], [ "A", b, b, 0, +(180 < c), 1, g, d ] ]
                };
            };
            a.customAttributes.segment = function(a, b) {
                var c = -90, b = b - 1, a = c + a, d = 180 < a - c, e = l / 2 + h, f = l / 2 + h, c = c % 360 * Math.PI / 180, a = a % 360 * Math.PI / 180;
                return {
    ...
    o.prototype = {
        ...
        goFar: function(a) {
            var d = this, c = a == d.defs.total - 1 && 0 == d.defs.slide ? -1 : a - d.defs.slide;
        ...
        processTimer: function() {
            if ("360bar" == this.defs.timer) {
                var a = 0 == this.defs.degree ? 0 : this.defs.degree - .9;
                this.timerPath.attr({
                    arc: [ a, this.R ]
                });
            } else "pie" == this.defs.timer ? (a = 0 == this.defs.degree ? 0 : this.defs.degree - .9, 
            this.pieTimer.attr({
                segment: [ a, this.R ]
            })) : this.barTimer.css({
        ...
        layout: function(a, d) {
            this.setItems();
            var c = "auto" == this.defs.topSpace ? this.defs.height / 2 - this.defs.currentSlide.data("outerheight") / 2 : 0, b = this.defs.width / 2 - this.defs.currentSlide.data("outerwidth") / 2, e = 999, f = {}, f = d ? d / 1e3 : this.options.animationSpeed / 1e3;
            ...
            for (c = 0; c < this.rightItems.length; c++) b = this.rightItems[c], e -= c + 1, 
            f = this.CSS(b, c, e, !0), cssA = this.CSS(b, c, e, !0, !0), b.css(f).css({
                opacity: 1,
                visibility: "visible"
            });
            for (c = 0; c < this.leftItems.length; c++) b = this.leftItems[c], e -= c + 1, f = this.CSS(b, c, e), 
            b.css(f).css({
                opacity: 1,
                visibility: "visible"
            });
            this.defs.total > this.options.slides && (this.rightOutItem.css(this.CSS(this.rightOutItem, this.leftItems.length - .5, this.leftItems.length - 1, !0)), 
            this.leftOutItem.css(this.CSS(this.leftOutItem, this.leftItems.length - .5, this.leftItems.length - 1)));
        },
        setItems: function() {
        ...
        CSS: function(a, d, c, b) {
            ...
            if (this.support.transform3d() && this.options.make3D) var f = b ? "translateX(" + e + "px) translateZ(-" + (250 + 110 * (d + 1)) + "px) rotateY(-" + this.options.perspective + "deg)" : "translateX(-" + e + "px) translateZ(-" + (250 + 110 * (d + 1)) + "px) rotateY(" + this.options.perspective + "deg)", b = "0%", d = "auto" == this.defs.topSpace ? "none" : parseInt((d + 1) * this.defs.space), a = e = "none", h = "visible"; else this.support.transform2d() ? (f = b ? "translateX(" + e / 1.5 + "px) scale(" + (1 - d / 10 - .1) + ")" : "translateX(-" + e / 1.5 + "px) scale(" + (1 - d / 10 - .1) + ")", 
            b = "0%", d = "auto" == this.defs.topSpace ? "none" : parseInt((d + 1) * this.defs.topSpace), 
            a = e = "none", h = "visible") : (f = "", b = b ? e / 1.5 + 50 * (d + 2) + "px" : "-" + e / 1.5 + "px", 
            e = a.data("width") - 50 * (d + 2), a = a.data("height") - 50 * (d + 2), d = "auto" == this.defs.topSpace ? this.defs.height / 2 - a / 2 : parseInt((d + 1) * this.defs.topSpace), 
            h = "hidden");
            return css = {
                "-webkit-transform": f,
                "-moz-transform": f,
        ...
        events: function() {
            ...
            a.iCarouselTimer.click(function() {
                a.iCarouselTimer.hasClass("paused") ? (a.iCarouselTimer.removeClass("paused").attr("title", a.options.pauseLabel), 
                a.defs.pause = !1, null == a.defs.interval && (a.setTimer(), a.options.onPlay.call(this))) : (a.iCarouselTimer.addClass("paused").attr("title", a.options.playLabel), 
                a.defs.pause = !0, clearInterval(a.defs.interval), a.defs.interval = null, a.options.onPause.call(this));
            });
            a.options.pauseOnHover && a.el.hover(function() {
                a.defs.pause || (clearInterval(a.defs.interval), a.defs.interval = null);
            }, function() {
                !a.defs.lock && (!a.defs.pause && null == a.defs.interval && 359 >= a.defs.degree && a.options.autoPlay) && a.setTimer();
            });
    ...
    g.fn.swipe = function(a) {
        ...
        g(this).each(function() {
            ...
            d.bind("touchend MozTouchRelease", function() {
                var d = b - f;
                d < a.threshold.y && d > -1 * a.threshold.y && (changeX = c - e, changeX > a.threshold.x && a.swipeLeft.call(this), 
                changeX < -1 * a.threshold.x && a.swipeRight.call(this));
            });
        });
    };
})(jQuery);