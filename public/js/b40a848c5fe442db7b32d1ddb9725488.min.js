var ajaxChat = {
    ...
    getUserNodeStringItems: function(encodedUserName, userID, isInline) {
        ...
        if (encodedUserName !== this.encodedUserName) {
            menu = "<li><a href=\"javascript:ajaxChat.insertMessageWrapper('/msg " + encodedUserName + ' \');" title="Private Message in chat.">' + this.lang["userMenuSendPrivateMessage"] + "</a></li>" + '<li><a target="_blank" href="../pm_system.php?action=send_message&amp;receiver=' + userID + '" title="Private Message using site messages.">' + "PM User " + "</a></li>" + "<li><a href=\"javascript:ajaxChat.sendMessageWrapper('/query " + encodedUserName + "');\">" + this.lang["userMenuOpenPrivateChannel"] + "</a></li>" + "<li><a href=\"javascript:ajaxChat.sendMessageWrapper('/query');\">" + this.lang["userMenuClosePrivateChannel"] + "</a></li>" + "<li><a href=\"javascript:ajaxChat.sendMessageWrapper('/ignore " + encodedUserName + "');\">" + this.lang["userMenuIgnore"] + "</a></li>";
            if (isInline) {
                menu += "<li><a href=\"javascript:ajaxChat.sendMessageWrapper('/invite " + encodedUserName + "');\">" + this.lang["userMenuInvite"] + "</a></li>" + "<li><a href=\"javascript:ajaxChat.sendMessageWrapper('/uninvite " + encodedUserName + "');\">" + this.lang["userMenuUninvite"] + "</a></li>" + "<li><a href=\"javascript:ajaxChat.sendMessageWrapper('/whereis " + encodedUserName + "');\">" + this.lang["userMenuWhereis"] + "</a></li>";
            }
