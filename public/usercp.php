...
while ($templ = mysqli_fetch_assoc($templates)) {
    if (file_exists("templates/$templ[id]/template.php")) {
        $stylesheets .= "<option value='" . (int)$templ['id'] . "'" . ($templ['id'] == get_stylesheet() ? " selected='selected'" : '') . '>' . htmlsafechars($templ['name']) . '</option>';
    }
}
...
elseif ($action == 'social') {
    ...
    //=== social stuff
    $HTMLOUT .= tr('Google Talk', '<img src="./images/forums/google_talk.gif" alt="Google Talk" title="Google Talk" /><input type="text" size="30" name="google_talk"  value="' . htmlsafechars($CURUSER['google_talk']) . '" />', 1);
    $HTMLOUT .= tr('MSN ', '<img src="./images/forums/msn.gif" alt="Msn" title="Msn" /><input type="text" size="30" name="msn"  value="' . htmlsafechars($CURUSER['msn']) . '" />', 1);
    $HTMLOUT .= tr('AIM', ' <img src="./images/forums/aim.gif" alt="Aim" title="Aim" /><input type="text" size="30" name="aim"  value="' . htmlsafechars($CURUSER['aim']) . '" />', 1);
...
elseif ($action == 'torrents') {
    ...
    $HTMLOUT .= tr($lang['usercp_cats_sets'], "<select name='categorie_icon'>
     <option value='1'" . (get_categorie_icons() == 1 ? " selected='selected'" : '') . ">Default</option>
     <option value='2'" . (get_categorie_icons() == 2 ? " selected='selected'" : '') . ">Future</option>
     <option value='3'" . (get_categorie_icons() == 3 ? " selected='selected'" : '') . ">Alt</option>
