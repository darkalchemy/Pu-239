...
if (in_array('latest_movies', $available_columns) && $CURUSER['blocks']['index_page'] & block_index::LATEST_MOVIES && $BLOCKS['latest_movies_on']) {
    include_once $dir . 'latest_movies.php';
} else {
    $remove_columns[] = 'latest_movies';
}

if (in_array('latest_tv', $available_columns) && $CURUSER['blocks']['index_page'] & block_index::LATEST_TV && $BLOCKS['latest_tv_on']) {
