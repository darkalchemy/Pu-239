...
if ($user['class'] >= UC_STAFF) {
    ...
    <option value='1'>" . _('Free for %d week', 1) . "</option>
    <option value='2'>" . _('Free for %d weeks', 2) . "</option>
    <option value='4'>" . _('Free for %d weeks', 4) . "</option>
    <option value='8'>" . _('Free for %d weeks', 8) . "</option>
    ...
    <option value='1'>" . _('Silver for %d week', 1) . "</option>
    <option value='2'>" . _('Silver for %d weeks', 2) . "</option>
    <option value='4'>" . _('Silver for %d weeks', 4) . "</option>
    <option value='8'>" . _('Silver for %d weeks', 8) . "</option>
    <option value='255'>" . _('Unlimited') . '</option>
    </select>'), 1);
    if ($row['silver'] != 0) {
