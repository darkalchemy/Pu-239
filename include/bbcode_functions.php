...
function format_comment($text, $strip_html = true, $urls = true, $images = true)
{
    ...
    $bb_code_out = [
        ...
        "<div class='responsive-container'><iframe width='1920px' height='1080px' src='//youtube.com/embed/\\1?vq=hd1080' autoplay='false' frameborder='0' allowfullscreen></youtube></div>",
