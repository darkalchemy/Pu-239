    ...
    foreach ($items as $item) {
        ...
        $html .= "
            <div class='bordered $top'>
                ...
                '<![CDATA[',
                ']]>',
            ], '', htmlsafechars($item->getElementsByTagName('creator')->item(0)->nodeValue)) . ' on ' . htmlsafechars($item->getElementsByTagName('pubDate')
                                                                                           ->item(0)->nodeValue) . '
                        </div>
                        <div>' . str_replace([
                '<![CDATA[',
                ...
                'href="' . $site_config['site']['anonymizer_url'],
                            ...
                            <a href='{$site_config['site']['anonymizer_url']}" . $item->getElementsByTagName('link')->item(0)->nodeValue . "' target='_blank'>
