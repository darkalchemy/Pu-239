    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        while ($arr = mysqli_fetch_assoc($res)) {
            ...
            if ($seedbonus >= 1 && $lvl == 0) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Bonus Banker LVL1[/b] achievement. :) [img]' . $INSTALLER09['baseurl'] . '/images/achievements/bonus1.png[/img]');
            ...
            if ($seedbonus >= 100 && $lvl == 1) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Bonus Banker LVL2[/b] achievement. :) [img]' . $INSTALLER09['baseurl'] . '/images/achievements/bonus2.png[/img]');
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($seedbonus >= 500 && $lvl == 2) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Bonus Banker LVL3[/b] achievement. :) [img]' . $INSTALLER09['baseurl'] . '/images/achievements/bonus3.png[/img]');
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($seedbonus >= 1000 && $lvl == 3) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Bonus Banker LVL4[/b] achievement. :) [img]' . $INSTALLER09['baseurl'] . '/images/achievements/bonus4.png[/img]');
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($seedbonus >= 2000 && $lvl == 4) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Bonus Banker LVL5[/b] achievement. :) [img]' . $INSTALLER09['baseurl'] . '/images/achievements/bonus5.png[/img]');
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($seedbonus >= 5000 && $lvl == 5) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Bonus Banker LVL6[/b] achievement. :) [img]' . $INSTALLER09['baseurl'] . '/images/achievements/bonus6.png[/img]');
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($seedbonus >= 10000 && $lvl == 6) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Bonus Banker LVL7[/b] achievement. :) [img]' . $INSTALLER09['baseurl'] . '/images/achievements/bonus7.png[/img]');
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($seedbonus >= 30000 && $lvl == 7) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Bonus Banker LVL8[/b] achievement. :) [img]' . $INSTALLER09['baseurl'] . '/images/achievements/bonus8.png[/img]');
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($seedbonus >= 70000 && $lvl == 8) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Bonus Banker LVL9[/b] achievement. :) [img]' . $INSTALLER09['baseurl'] . '/images/achievements/bonus9.png[/img]');
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($seedbonus >= 100000 && $lvl == 9) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Bonus Banker LVL10[/b] achievement. :) [img]' . $INSTALLER09['baseurl'] . '/images/achievements/bonus10.png[/img]');
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($seedbonus >= 1000000 && $lvl == 10) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Bonus Banker LVL11[/b] achievement. :) [img]' . $INSTALLER09['baseurl'] . '/images/achievements/bonus11.png[/img]');
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
