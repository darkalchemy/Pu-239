...
function achievement_up_update($data)
{
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        while ($arr = mysqli_fetch_assoc($res)) {
            ...
            $ul = (int)$arr['ul'];
            if ($uploads >= 1 && $ul == 0) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Uploader LVL1[/b] achievement. :) [img]' . $site_config['pic_base_url'] . 'achievements/ul1.png[/img]');
            ...
            if ($uploads >= 50 && $ul == 1) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Uploader LVL2[/b] achievement. :) [img]' . $site_config['pic_base_url'] . 'achievements/ul2.png[/img]');
                $msgs_buffer[] = "(0, {$arr['id']}, $dt, $msg, $subject)";
            ...
            if ($uploads >= 100 && $ul == 2) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Uploader LVL3[/b] achievement. :) [img]' . $site_config['pic_base_url'] . 'achievements/ul3.png[/img]');
                $msgs_buffer[] = "(0, {$arr['id']}, $dt, $msg, $subject)";
            ...
            if ($uploads >= 200 && $ul == 3) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Uploader LVL4[/b] achievement. :) [img]' . $site_config['pic_base_url'] . 'achievements/ul4.png[/img]');
                $msgs_buffer[] = "(0, {$arr['id']}, $dt, $msg, $subject)";
            ...
            if ($uploads >= 300 && $ul == 4) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Uploader LVL5[/b] achievement. :) [img]' . $site_config['pic_base_url'] . 'achievements/ul5.png[/img]');
                $msgs_buffer[] = "(0, {$arr['id']}, $dt, $msg, $subject)";
            ...
            if ($uploads >= 500 && $ul == 5) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Uploader LVL6[/b] achievement. :) [img]' . $site_config['pic_base_url'] . 'achievements/ul6.png[/img]');
                $msgs_buffer[] = "(0, {$arr['id']}, $dt, $msg, $subject)";
            ...
            if ($uploads >= 800 && $ul == 6) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Uploader LVL7[/b] achievement. :) [img]' . $site_config['pic_base_url'] . 'achievements/ul7.png[/img]');
                $msgs_buffer[] = "(0, {$arr['id']}, $dt, $msg, $subject)";
            ...
            if ($uploads >= 1000 && $ul == 7) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Uploader LVL8[/b] achievement. :) [img]' . $site_config['pic_base_url'] . 'achievements/ul8.png[/img]');
                $msgs_buffer[] = "(0, {$arr['id']}, $dt, $msg, $subject)";
            ...
            if ($uploads >= 1500 && $ul == 8) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Uploader LVL9[/b] achievement. :) [img]' . $site_config['pic_base_url'] . 'achievements/ul9.png[/img]');
                $msgs_buffer[] = "(0, {$arr['id']}, $dt, $msg, $subject)";
            ...
            if ($uploads >= 2000 && $ul == 9) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Uploader LVL10[/b] achievement. :) [img]' . $site_config['pic_base_url'] . 'achievements/ul10.png[/img]');
                $msgs_buffer[] = "(0, {$arr['id']}, $dt, $msg, $subject)";
