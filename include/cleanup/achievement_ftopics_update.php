...
function achievement_ftopics_update($data)
{
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        while ($arr = mysqli_fetch_assoc($res)) {
            ...
            if ($topics >= 1 && $lvl == 0) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Forum Topic Starter Level 1[/b] achievement. :) [img]' . $site_config['pic_base_url'] . 'achievements/ftopic1.png[/img]');
            ...
            if ($topics >= 10 && $lvl == 1) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Forum Topic Starter Level 2[/b] achievement. :) [img]' . $site_config['pic_base_url'] . 'achievements/ftopic2.png[/img]');
                $msgs_buffer[] = "(0, {$arr['userid']} , $dt, $msg, $subject)";
            ...
            if ($topics >= 25 && $lvl == 2) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Forum Topic Starter Level 3[/b] achievement. :) [img]' . $site_config['pic_base_url'] . 'achievements/ftopic3.png[/img]');
                $msgs_buffer[] = "(0, {$arr['userid']} , $dt, $msg, $subject)";
            ...
            if ($topics >= 50 && $lvl == 3) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Forum Topic Starter Level 4[/b] achievement. :) [img]' . $site_config['pic_base_url'] . 'achievements/ftopic4.png[/img]');
                $msgs_buffer[] = "(0, {$arr['userid']} , $dt, $msg, $subject)";
            ...
            if ($topics >= 75 && $lvl == 4) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Forum Topic Starter Level 5[/b] achievement. :) [img]' . $site_config['pic_base_url'] . 'achievements/ftopic5.png[/img]');
                $msgs_buffer[] = "(0, {$arr['userid']} , $dt, $msg, $subject)";
