    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        while ($arr = mysqli_fetch_assoc($res)) {
            ...
            if ($reqfilled >= 1 && $lvl == 0) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Request Filler LVL1[/b] achievement. :) [img]' . $INSTALLER09['baseurl'] . '/images/achievements/reqfiller1.png[/img]');
            ...
            if ($reqfilled >= 5 && $lvl == 1) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Request Filler LVL2[/b] achievement. :) [img]' . $INSTALLER09['baseurl'] . '/images/achievements/reqfiller2.png[/img]');
                $msgs_buffer[] = '(0,' . $arr['userid'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($reqfilled >= 10 && $lvl == 2) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Request Filler LVL3[/b] achievement. :) [img]' . $INSTALLER09['baseurl'] . '/images/achievements/reqfiller3.png[/img]');
                $msgs_buffer[] = '(0,' . $arr['userid'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($reqfilled >= 25 && $lvl == 3) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Request Filler LVL4[/b] achievement. :) [img]' . $INSTALLER09['baseurl'] . '/images/achievements/reqfiller4.png[/img]');
                $msgs_buffer[] = '(0,' . $arr['userid'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($reqfilled >= 50 && $lvl == 4) {
                $msg = sqlesc('Congratulations, you have just earned the [b]Request Filler LVL5[/b] achievement. :) [img]' . $INSTALLER09['baseurl'] . '/images/achievements/reqfiller5.png[/img]');
                $msgs_buffer[] = '(0,' . $arr['userid'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
