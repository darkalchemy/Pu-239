   ...
   <tr>
    ...
    case 'delete':
        ...
        if (!$sure) {
         ...
         <a class="altlink" href="' . $site_config['paths']['baseurl'] . '/staffpanel.php?tool=shit_list&amp;action=shit_list&amp;action2=delete&amp;shit_list_id=' . $shit_list_id . '&amp;sure=1"><span class="button is-small" style="padding:1px;">' . $lang['shitlist_delete5'] . '</span></a>' . $lang['shitlist_delete6'] . '');
        }
...
$HTMLOUT .= '</table><p><span class="button is-small" style="padding:3px;"><img style="vertical-align:middle;" src="' . $site_config['paths']['images_baseurl'] . 'btn_search.gif"><a class="altlink" href="' . $site_config['paths']['baseurl'] . '/users.php">' . $lang['shitlist_find'] . '</span></a></p>';
