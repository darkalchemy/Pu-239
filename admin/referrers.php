    ...
    if (mysqli_num_rows($res) > 0) {
        while ($data = mysqli_fetch_assoc($res)) {
            ...
            if (strstr($http_agent, 'Opera')) {
                $browser = "<img src='{$site_config['pic_baseurl']}referrers/opera.png' alt='Opera' title='Opera' width='25' height='25' border='0' />&#160;&#160;Opera";
            } elseif (strstr($http_agent, 'Konqueror')) {
                $browser = "<img src='{$site_config['pic_baseurl']}referrers/konqueror.png' alt='konqueror' title='konqueror' width='25' height='25' border='0' />&#160;&#160;konqueror";
            } elseif (strstr($http_agent, 'MSIE')) {
                $browser = "<img src='{$site_config['pic_baseurl']}referrers/ie.png' alt='IE' title='IE' width='25' height='25' border='0' />&#160;&#160;IE";
            } elseif (strstr($http_agent, 'Chrome')) {
                $browser = "<img src='{$site_config['pic_baseurl']}referrers/chrome.png' alt='Chrome' title='Chrome' width='25' height='25' border='0' />&#160;&#160;Chrome";
                ...
                $browser = "<img src='{$site_config['pic_baseurl']}referrers/firefox.png' alt='FireFox' title='FireFox' width='25' height='25' border='0' />&#160;&#160;Mozilla";
            } else {
