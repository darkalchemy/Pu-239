<?php
 ...
 /* $Id: imdb_person.class.php 636 2013-12-01 22:25:44Z izzy $ */
  ...
  * @version $Revision: 636 $ $Date: 2013-12-01 23:25:44 +0100 (So, 01. Dez 2013) $
  */
 ...
 #========================================================[ Common methods ]===
     ...
     public function __construct($id)
     {
         ...
         $this->revision = preg_replace('|^.*?(\d+).*$|', '$1', '$Revision: 636 $');
         $this->setid($id);
     }
     ...
     public function bio()
     {
         if (empty($this->bio_bio)) {
             ...
             "href=\"/name/nm",
             .$this->imdbsite."/name/nm",
                              str_replace(
                                  "href=\"/title/tt",
                                  .$this->imdbsite."/title/tt",
