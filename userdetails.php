...
if ($CURUSER['class'] >= UC_STAFF && $user['class'] < $CURUSER['class']) {
   ...
   <input name='signatures' value='no' type='radio'" . ($user['signatures'] == 'no' ? " checked='checked'" : '') . " /></td>
    ...
    if ($CURUSER['class'] >= UC_STAFF && XBT_TRACKER == false) {
        $HTMLOUT .= "<tr><td class='rowhead'>{$lang['userdetails_freeleech_slots']}</td><td colspan='2' align='left'>
    ...
    if ($CURUSER['class'] >= UC_ADMINISTRATOR && XBT_TRACKER == false) {
        ...
        if ($free_switch) {
            if ($user['free_switch'] == 1) {
                ...
                $HTMLOUT .= "<td align='center'>{$lang['userdetails_until']} " . get_date($user['free_switch'], 'DATE') . ' (' . mkprettytime($user['free_switch'] - TIME_NOW) . " {$lang['userdetails_togo']})</td></tr>";
            }
        } else {
    ...
    if ($CURUSER['class'] >= UC_STAFF && XBT_TRACKER == false) {
        ...
        if ($downloadpos) {
            if ($user['downloadpos'] == 0) {
                ...
                $HTMLOUT .= "<td align='center'>{$lang['userdetails_until']} " . get_date($user['downloadpos'], 'DATE') . ' (' . mkprettytime($user['downloadpos'] - TIME_NOW) . " {$lang['userdetails_togo']})</td></tr>";
            }
        } else {
    ...
    if ($CURUSER['class'] >= UC_STAFF) {
        ...
        if ($uploadpos) {
            if ($user['uploadpos'] == 0) {
                ...
                $HTMLOUT .= "<td align='center'>{$lang['userdetails_until']} " . get_date($user['uploadpos'], 'DATE') . ' (' . mkprettytime($user['uploadpos'] - TIME_NOW) . " {$lang['userdetails_togo']})</td></tr>";
            }
        } else {
    ...
    if ($CURUSER['class'] >= UC_STAFF) {
        ...
        if ($sendpmpos) {
            if ($user['sendpmpos'] == 0) {
                ...
                $HTMLOUT .= "<td align='center'>{$lang['userdetails_until']} " . get_date($user['sendpmpos'], 'DATE') . ' (' . mkprettytime($user['sendpmpos'] - TIME_NOW) . " {$lang['userdetails_togo']})</td></tr>";
            }
        } else {
    ...
    if ($CURUSER['class'] >= UC_STAFF) {
        ...
        if ($chatpost) {
            if ($user['chatpost'] == 0) {
                ...
                $HTMLOUT .= "<td align='center'>{$lang['userdetails_until']} " . get_date($user['chatpost'], 'DATE') . ' (' . mkprettytime($user['chatpost'] - TIME_NOW) . " {$lang['userdetails_togo']})</td></tr>";
            }
        } else {
    ...
    if ($CURUSER['class'] >= UC_STAFF) {
        ...
        if ($avatarpos) {
            if ($user['avatarpos'] == 0) {
                ...
                $HTMLOUT .= "<td align='center'>{$lang['userdetails_until']} " . get_date($user['avatarpos'], 'DATE') . ' (' . mkprettytime($user['avatarpos'] - TIME_NOW) . " {$lang['userdetails_togo']})</td></tr>";
            }
        } else {
    ...
    if ($CURUSER['class'] >= UC_STAFF) {
        ...
        if ($immunity) {
            if ($user['immunity'] == 1) {
                ...
                $HTMLOUT .= "<td align='center'>{$lang['userdetails_until']} " . get_date($user['immunity'], 'DATE') . ' (' . mkprettytime($user['immunity'] - TIME_NOW) . " {$lang['userdetails_togo']})</td></tr>";
            }
        } else {
    ...
    if ($CURUSER['class'] >= UC_STAFF) {
        ...
        if ($leechwarn) {
            if ($user['leechwarn'] == 1) {
                ...
                $HTMLOUT .= "<td align='center'>{$lang['userdetails_until']} " . get_date($user['leechwarn'], 'DATE') . ' (' . mkprettytime($user['leechwarn'] - TIME_NOW) . " {$lang['userdetails_togo']})</td></tr>";
            }
        } else {
    ...
    if ($CURUSER['class'] >= UC_STAFF) {
        ...
        if ($warned) {
            if ($user['warned'] == 1) {
                ...
                $HTMLOUT .= "<td align='center'>{$lang['userdetails_until']} " . get_date($user['warned'], 'DATE') . ' (' . mkprettytime($user['warned'] - TIME_NOW) . " {$lang['userdetails_togo']})</td></tr>";
            }
        } else {
    ...
    if (XBT_TRACKER == true) {
        // == Wait time
        if ($CURUSER['class'] >= UC_STAFF) {
            $HTMLOUT .= "<tr><td class='rowhead'>{$lang['userdetails_waittime']}</td><td colspan='2' align='left'><input type='text' size='6' name='wait_time' value='" . (int)$user['wait_time'] . "' /></td></tr>";
        }
        // ==end
        // == Peers limit
        if ($CURUSER['class'] >= UC_STAFF) {
            $HTMLOUT .= "<tr><td class='rowhead'>{$lang['userdetails_peerslimit']}</td><td colspan='2' align='left'><input type='text' size='6' name='peers_limit' value='" . (int)$user['peers_limit'] . "' /></td></tr>";
        }
        // ==end
        // == Torrents limit
        if ($CURUSER['class'] >= UC_STAFF) {
            $HTMLOUT .= "<tr><td class='rowhead'>{$lang['userdetails_torrentslimit']}</td><td colspan='2' align='left'><input type='text' size='6' name='torrents_limit' value='" . (int)$user['torrents_limit'] . "' /></td></tr>";
        }
        // ==end
    }
    //==High speed
