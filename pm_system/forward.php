...
if ($message['sender'] == $CURUSER['id'] && $message['sender'] == $CURUSER['id'] || 0 === mysqli_num_rows($res)) {
...
if ($message['sender'] !== $CURUSER['id']) {
    ...
    $forwarded_username = (0 === $message['sender'] ? $lang['pm_forward_system'] : (0 === mysqli_num_rows($res_forward) ? $lang['pm_forward_unknow'] : $arr_forward['username']));
} else {
