        ...
        if ($arr_post_read[0] < $arr_unread['last_post']) {
            ...
            <tr>
                ...
                <td>
                    <table>
                        <tr>
                            <td>' . $topic_name . $first_post_text . ' [ <a class="is-link" href="' . $site_config['paths']['baseurl'] . '/forums.php?action=clear_unread_post&amp;topic_id=' . (int) $arr_unread['topic_id'] . '&amp;last_post=' . (int) $arr_unread['last_post'] . '" title="' . $lang['fe_remove'] . ' ' . $lang['vup_remove_topic_from_unread_list'] . '.">' . $lang['fe_remove'] . '</a> ] ' . $topic_status_image . '</td>
                            <td>' . $rpic . '</td>
                        </tr>
                    </table>
