            ...
            <td colspan="3">
                <div class="columns level-center">
                    ...
                    <div class="column">
                        ...
                        ' . ($CURUSER['class'] == UC_MAX && $arr['staff_lock'] == 1 ? '<a href="' . $site_config['baseurl'] . '/forums.php?action=staff_lock&amp;mode=unlock&amp;post_id=' . $post_id . '&amp;topic_id=' . $topic_id . '" title="' . $lang['fe_un_lock'] . '" class="tooltipper"><i class="icon-key icon"></i>' . $lang['fe_unlock_post'] . '</a>' : '') . '
                        ' . ($CURUSER['class'] == UC_MAX && $arr['staff_lock'] == 0 ? '<a href="' . $site_config['baseurl'] . '/forums.php?action=staff_lock&amp;mode=lock&amp;post_id=' . $post_id . '&amp;topic_id=' . $topic_id . '" title="' . $lang['fe_lock'] . '" class="tooltipper"><i class="icon-key icon"></i>' . $lang['fe_lock_post'] . '</a>' : '') . $stafflocked . '
