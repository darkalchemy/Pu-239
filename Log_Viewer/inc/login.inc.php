...
<div class="jumbotron">
    <center>
        <div class="container">
            <div class="container">
                <div class="row">
                    <div class="input-group col-sm-6 col-md-4"><?php
                        if ((int)@$error === 1) {
            ...
            <h2><?php echo __('Please sign in'); ?></h2><br>
            <form method="POST" action="?">
                <div class="container">
                    <div class="row">
                        <div class="input-group col-sm-6 col-md-4"><span class="input-group-addon"><span
                                        class="glyphicon glyphicon-user"></span></span> <?php
                    ...
                    <div class="row">
                        <div class="input-group col-sm-6 col-md-4"><span class="input-group-addon"><span
                                        class="glyphicon glyphicon-lock"></span></span> <?php
                            if (strlen('' . @$_POST['username']) === 0) {
                ...
                <br><br><input type="submit" class="btn btn-primary" value="Pimp my Logs"><input type="hidden"
                                                                                                 name="csrf_token"
                                                                                                 value="<?php echo csrf_get(); ?>"><input
                        type="hidden" name="attempt" value="<?php echo htmlentities($attempt, ENT_QUOTES, 'UTF-8'); ?>">
            </form>
            <br><a href="<?php echo FORGOTTEN_YOUR_PASSWORD_URL; ?>"><?php _e('Forgotten your password?') ?></a></div>
    </center>
</div>
<div class="container">
...
<script src="js/login.min.js"></script><?php if (('UA-XXXXX-X' != GOOGLE_ANALYTICS) && ('' != GOOGLE_ANALYTICS)) {
    ?>
