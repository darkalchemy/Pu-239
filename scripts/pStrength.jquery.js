(function ($) {
    var numbers_array = new Array(), upper_letters_array = new Array(), lower_letters_array = new Array(),
        special_chars_array = new Array(), pStrengthElementsDefaultStyle = new Array(), settings, methods = {
            init: function (options, callbacks) {
                settings = $.extend({
                    bind: 'keyup change',
                    changeBackground: true,
                    backgrounds: [['#c00', '#000'], ['#c33', '#000'], ['#c66', '#000'], ['#f99', '#000'], ['#e0941c', '#000'], ['#e8a53a', '#000'], ['#eab259', '#000'], ['#efd09e', '#000'], ['#cfc', '#000'], ['#6c6', '#000'], ['#393', '#000'], ['#060', '#000'], ['#105610', '#000']],
    ...
    var calculatePasswordStrength = function () {
        var passwordStrength = 0, numbers_found = 0, upper_letters_found = 0, lower_letters_found = 0,
            special_chars_found = 0, text = $(this).val().trim();
