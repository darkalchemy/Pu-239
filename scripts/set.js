...
//mySettings = {
    ...
    markupSet: [
...

        {
            name: 'Font',
            key: 'F',
            openWith: '[font=[![Enter web-safe font]!]]',
            closeWith: '[/font]',
        ...
        {
            name: 'Size',
            openWith: '[size=[![Enter text size, 1 to 7.]!]]',
            closeWith: '[/size]',
        ...
        {
            name: 'Remove Selected Formatting', className: "clean", replaceWith: function (h) {
