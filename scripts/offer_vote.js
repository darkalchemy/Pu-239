$('.offer_vote').on('click', function () {
    $.ajax({
        url: './ajax/offer_vote.php',
        type: 'POST',
        dataType: 'json',
        context: this,
        data: {
        ...
        success: function (data) {
            ...
            if (data['voted'] === 'invalid') {
                ...
                $(this).tooltipster('content', 'You support this offer.');
                ...
                $(this).tooltipster('content', 'You oppose this offer.');
            } else {
                $(this).attr('data-voted', 0);
                $(this).html("<i class='icon-thumbs-down icon is-marginless' aria-hidden='true'></i>");
                $(this).tooltipster('content', 'You have not voted for or against this offer.');
            }
        }
    });
});
