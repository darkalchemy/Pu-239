...
animatedcollapse.addDiv('xzlogin', 'fade=1,height=auto')
animatedcollapse.addDiv('xzrecover', 'fade=1,height=auto')
animatedcollapse.addDiv('xzsignup', 'fade=1,height=auto')
