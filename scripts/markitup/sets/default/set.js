var myBbcodeSettings = {
    ...
    markupSet: [
            ...
            {name:'Link', key:'L', openWith:'[url=[![Url]!]]', closeWith:'[/url]', className:'linkbutton', placeHolder:'Your text to link here...'},
            {name:'Youtube / Google Video', openWith:'[video=[![Enter URL to Google Or Yahoo Video Here]!]]', className:'youtubebutton'},
            ...
            {name:'Fonts', className:'fontsbutton', dropMenu: [
                ...
                {name:'PT Sans Narrow', showName:'PT Sans Narrow', openWith:'[font02]', closeWith:'[/font02]', className:'text-2'},
                {name:'Nova Square', showName:'Nova Square', openWith:'[font03]', closeWith:'[/font03]', className:'text-3'},
                {name:'Lobster', showName:'Lobster', openWith:'[font04]', closeWith:'[/font04]', className:'text-4'},
                {name:'Open Sans', showName:'Open Sans', openWith:'[font05]', closeWith:'[/font05]', className:'text-5'},
                {name:'Encode Sans Condensed', showName:'Encode Sans Condensed', openWith:'[font06]', closeWith:'[/font06]', className:'text-6'},
                {name:'Baloo Bhaijaan', showName:'Baloo Bhaijaan', openWith:'[font07]', closeWith:'[/font07]', className:'text-7'},
                ...
                {name:'Arial Black', showName:'Arial Black', openWith:'[font=Arial Black]', closeWith:'[/font]', className:"font_Arial" },
                {name:'Comic Sans MS', showName:'Comic Sans MS', openWith:'[font=Comic Sans MS]', closeWith:'[/font]', className:"font_Comic_Sans_MS" },
                {name:'Courier New', showName:'Courier New', openWith:'[font=Courier New]', closeWith:'[/font]', className:"font_Courier_New" },
                {name:'Georgia', showName:'Georgia', openWith:'[font=Georgia]', closeWith:'[/font]', className:"font_Georgia" },
                {name:'Impact', showName:'Impact', openWith:'[font=Impact]', closeWith:'[/font]', className:"font_Impact" },
                {name:'Times New Roman', showName:'Times New Roman', openWith:'[font=Times New Roman]', closeWith:'[/font]', className:"font_Times_New_Roman" },
                {name:'Trebuchet MS', showName:'Trebuchet MS', openWith:'[font=Trebuchet MS]', closeWith:'[/font]', className:"font_Trebuchet_MS" },
                {name:'Verdana', showName:'Verdana', openWith:'[font=Verdana]', closeWith:'[/font]', className:"font_Verdana" },
                {name:'Courier', showName:'Courier', openWith:'[font=Courier]', closeWith:'[/font]', className:"font_Courier" },
                {name:'Helvetica', showName:'Helvetica', openWith:'[font=Helvetica]', closeWith:'[/font]', className:"font_Helvetica" },
                {name:'Times', showName:'Times', openWith:'[font=Times]', closeWith:'[/font]', className:"font_Times" },
                {name:'Andale Mono', showName:'Andale Mono', openWith:'[font=Andale Mono]', closeWith:'[/font]', className:"font_Andale_Mono" },
                {name:'Bitstream Vera Sans', showName:'Bitstream Vera Sans', openWith:'[font=Bitstream Vera Sans]', closeWith:'[/font]', className:"font_Bitstream_Vera_Sans" },
            ...
            {name:'Size', key:'S', openWith:'[size=[![Text size]!]]', closeWith:'[/size]', className:'sizebutton', dropMenu :[
                {name:'xx-large', showName:'xx-large', openWith:'[size=7]', closeWith:'[/size]', className:'size_7'},
                ...
                {name:'xx-small', showName:'xx-small', openWith:'[size=1]', closeWith:'[/size]', className:'size_1'},
                ]
            },
            {separator:' '},
            ...
            {separator:' '},
            {name:'Remove Formatting from Selected Text', className:'clean', replaceWith:function(h) { return h.selection.replace(/\[(.*?)\]/g, '') } },
